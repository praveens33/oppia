...
REPORT_SUBMITTED_TIMESTAMP = from_milliseconds_utc(1615151836 * 1000.0)
...
TICKET_ID = '%s.%s.%s' % ('random_hash', int(TICKET_CREATION_TIMESTAMP_MSEC
    ), '16CharString1234')
...
CATEGORY_SUGGESTION_OTHER = (app_feedback_report_constants.Category.
    OTHER_SUGGESTION)
...
ANDROID_TEXT_SIZE = (app_feedback_report_constants.AndroidTextSize.
    MEDIUM_TEXT_SIZE)
...
ANDROID_REPORT_INFO: app_feedback_report_models.ReportInfoDict = {
    ...
    'user_feedback_other_text_input': USER_TEXT_INPUT, 'event_logs': [
    'event1', 'event2'], 'logcat_logs': ['logcat1', 'logcat2'],
    'package_version_code': ANDROID_PACKAGE_VERSION_CODE,
    'build_fingerprint': ANDROID_BUILD_FINGERPRINT, 'network_type':
    NETWORK_WIFI.value, 'android_device_language_locale_code':
    LANGUAGE_LOCALE_CODE_ENGLISH, 'language_locale_code': 'en',
    'entry_point_info': {'entry_point_name': ENTRY_POINT_NAVIGATION_DRAWER},
...
WEB_REPORT_INFO = {'user_feedback_selected_items': [],
...
REPORT_JSON: app_feedback_report_domain.AndroidFeedbackReportDict = {
    ...
    'app_context': {'entry_point': {'entry_point_name': 'navigation_drawer',
    'entry_point_exploration_id': None, 'entry_point_story_id': None,
    'entry_point_topic_id': None, 'entry_point_subtopic_id': None},
    'text_size': 'large_text_size', 'text_language_code': 'en',
    'audio_language_code': 'en', 'only_allows_wifi_download_and_update': 
    True, 'automatically_update_topics': False, 'account_is_profile_admin':
    False, 'event_logs': ['example', 'event'], 'logcat_logs': ['example',
    'log']}, 'device_context': {'android_device_model': 'example_model',
    'android_sdk_version': 23, 'build_fingerprint':
    ...
    'platform_version': '0.1-alpha-abcdef1234', 'package_version_code': 1,
    'android_device_country_locale_code': 'in',
    'android_device_language_locale_code': 'en'}, 'user_supplied_feedback':
    {'report_type': 'suggestion', 'category': 'language_suggestion',
...
class AppFeedbackReportDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        ...
        self.android_report_id = (app_feedback_report_models.
            AppFeedbackReportModel.generate_id(PLATFORM_ANDROID,
            REPORT_SUBMITTED_TIMESTAMP))
        android_user_supplied_feedback = (app_feedback_report_domain.
            UserSuppliedFeedback(REPORT_TYPE_SUGGESTION,
            CATEGORY_SUGGESTION_OTHER, USER_SELECTED_ITEMS, USER_TEXT_INPUT))
        android_device_system_context = (app_feedback_report_domain.
            AndroidDeviceSystemContext(ANDROID_PLATFORM_VERSION,
            ANDROID_PACKAGE_VERSION_CODE, COUNTRY_LOCALE_CODE_INDIA,
            LANGUAGE_LOCALE_CODE_ENGLISH, ANDROID_DEVICE_MODEL,
            ANDROID_SDK_VERSION, ANDROID_BUILD_FINGERPRINT, NETWORK_WIFI))
        navigation_drawer_entry_point = (app_feedback_report_domain.
            NavigationDrawerEntryPoint())
        ...
        self.android_report_obj = app_feedback_report_domain.AppFeedbackReport(
            ...
            PLATFORM_ANDROID, REPORT_SUBMITTED_TIMESTAMP, 0, TICKET_ID,
            None, android_user_supplied_feedback,
            android_device_system_context, android_app_context)
        self.web_report_id = (app_feedback_report_models.
            AppFeedbackReportModel.generate_id(PLATFORM_WEB,
            REPORT_SUBMITTED_TIMESTAMP))
        web_user_supplied_feedback = (app_feedback_report_domain.
            UserSuppliedFeedback(REPORT_TYPE_SUGGESTION,
            CATEGORY_SUGGESTION_OTHER, USER_SELECTED_ITEMS, USER_TEXT_INPUT))
        ...
        app_context = app_feedback_report_domain.AppContext(crash_entry_point,
            LANGUAGE_LOCALE_CODE_ENGLISH, LANGUAGE_LOCALE_CODE_ENGLISH)
        self.web_report_obj = app_feedback_report_domain.AppFeedbackReport(self
            .web_report_id, ANDROID_REPORT_INFO_SCHEMA_VERSION,
    ...
    def test_to_dict_android_report(self) ->None:
        ...
        expected_dict = {'report_id': expected_report_id, 'schema_version':
            ANDROID_REPORT_INFO_SCHEMA_VERSION, 'platform':
            PLATFORM_ANDROID, 'submitted_on_timestamp': utils.
            get_human_readable_time_string(utils.get_time_in_millisecs(
            REPORT_SUBMITTED_TIMESTAMP)), 'local_timezone_offset_hrs': 0,
            'ticket_id': TICKET_ID, 'scrubbed_by': None,
            'user_supplied_feedback': {'report_type':
            REPORT_TYPE_SUGGESTION.value, 'category':
            CATEGORY_SUGGESTION_OTHER.value, 'user_feedback_selected_items':
            USER_SELECTED_ITEMS, 'user_feedback_other_text_input':
            USER_TEXT_INPUT}, 'device_system_context': {'version_name':
            ANDROID_PLATFORM_VERSION, 'package_version_code':
            ANDROID_PACKAGE_VERSION_CODE, 'device_country_locale_code':
            COUNTRY_LOCALE_CODE_INDIA, 'device_language_locale_code':
            LANGUAGE_LOCALE_CODE_ENGLISH, 'device_model':
            ANDROID_DEVICE_MODEL, 'sdk_version': ANDROID_SDK_VERSION,
            'build_fingerprint': ANDROID_BUILD_FINGERPRINT, 'network_type':
            NETWORK_WIFI.value}, 'app_context': {'entry_point': {
            ...
            'account_is_profile_admin': False, 'event_logs': EVENT_LOGS,
    ...
    def test_raise_not_implemented_error_for_web_platform_feedback(self
        ) ->None:
    ...
    def test_android_report_creation_from_submitted_feedback(self) ->None:
        ...
        result = self.android_report_obj.from_submitted_feedback_dict(
            REPORT_JSON)
        expected_report_datetime = from_milliseconds_utc(REPORT_JSON[
            'report_submission_timestamp_sec'] * 1000.0)
        expected_report_schema_version = REPORT_JSON[
            'android_report_info_schema_version']
        self.assertEqual(result.submitted_on_timestamp,
    ...
    def test_report_platform_is_invalid_validation_fails(self) ->None:
        ...
        self._assert_validation_error(self.android_report_obj,
            'Report platform should be one of ')

    def test_report_scrubber_id_is_invalid_validation_fails(self) ->None:
        self.android_report_obj.scrubbed_by = 'invalid_user'
        self._assert_validation_error(self.android_report_obj, 
            "The scrubbed_by user id '%s' is invalid." % self.
            android_report_obj.scrubbed_by)

    def test_validate_android_report_with_bot_id_passes(self) ->None:
        """Tests that validation passes when the scrubbed_by ID is bot ID."""
        self.android_report_obj.scrubbed_by = (feconf.
            APP_FEEDBACK_REPORT_SCRUBBER_BOT_ID)
        self.android_report_obj.validate()
        self.assertEqual(self.android_report_obj.scrubbed_by, feconf.
            APP_FEEDBACK_REPORT_SCRUBBER_BOT_ID,
    ...
    def test_get_report_type_from_string_returns_expected_report_type(self
        ...
        for report_type in app_feedback_report_constants.ReportType:
            self.assertEqual(feedback_report.get_report_type_from_string(
    ...
    def test_get_category_from_string_returns_expected_category(self) ->None:
        ...
        for category in app_feedback_report_constants.ALLOWED_CATEGORIES:
            self.assertEqual(feedback_report.get_category_from_string(
    ...
    def test_get_android_text_size_from_string_returns_expected_text_size(self
        ...
        for text_size in app_feedback_report_constants.ALLOWED_ANDROID_TEXT_SIZES:
            self.assertEqual(feedback_report.
                get_android_text_size_from_string(text_size.value), text_size)
    ...
    def test_get_entry_point_from_json_returns_expected_entry_point_obj(self
        ...
        entry_point_json: app_feedback_report_domain.EntryPointDict = {
            'entry_point_name': '', 'entry_point_topic_id': 'topic_id',
        ...
        navigation_drawer_obj = feedback_report.get_entry_point_from_json(
            entry_point_json)
        self.assertTrue(isinstance(navigation_drawer_obj,
            app_feedback_report_domain.NavigationDrawerEntryPoint))
        entry_point_json['entry_point_name'
            ] = app_feedback_report_constants.EntryPoint.LESSON_PLAYER.value
        lesson_player_obj = feedback_report.get_entry_point_from_json(
            entry_point_json)
        self.assertTrue(isinstance(lesson_player_obj,
            app_feedback_report_domain.LessonPlayerEntryPoint))
        entry_point_json['entry_point_name'
            ] = app_feedback_report_constants.EntryPoint.REVISION_CARD.value
        revision_card_obj = feedback_report.get_entry_point_from_json(
            entry_point_json)
        self.assertTrue(isinstance(revision_card_obj,
        ...
        self.assertTrue(isinstance(crash_obj, app_feedback_report_domain.
            CrashEntryPoint))
    ...
    def test_get_android_network_type_from_string_returns_expected_network_type(
        ...
        for network_type in app_feedback_report_constants.AndroidNetworkType:
            self.assertEqual(feedback_report.
                get_android_network_type_from_string(network_type.value),
                network_type)
    ...
    def _assert_validation_error(self, report_obj:
    ...
    def _assert_not_implemented_error(self, report_obj:
        app_feedback_report_domain.AppFeedbackReport,
        expected_error_substring: str) ->None:
        """Checks that the feedback report passes validation.
...
class UserSuppliedFeedbackDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        super().setUp()
        self.user_supplied_feedback = (app_feedback_report_domain.
            UserSuppliedFeedback(REPORT_TYPE_SUGGESTION,
            CATEGORY_SUGGESTION_OTHER, USER_SELECTED_ITEMS, USER_TEXT_INPUT))

    def test_to_dict(self) ->None:
        expected_dict = {'report_type': REPORT_TYPE_SUGGESTION.value,
            'category': CATEGORY_SUGGESTION_OTHER.value,
            'user_feedback_selected_items': USER_SELECTED_ITEMS,
            'user_feedback_other_text_input': USER_TEXT_INPUT}
        self.assertDictEqual(expected_dict, self.user_supplied_feedback.
            to_dict())

    def test_validation_invalid_report_type_fails(self) ->None:
        self.user_supplied_feedback.report_type = 'invalid_report_type'
        self._assert_validation_error(self.user_supplied_feedback,
            'Invalid report type ')
    ...
    def test_validation_has_selected_items_for_invalid_category_fails(self
        ...
        self.user_supplied_feedback.user_feedback_selected_items = ['invalid',
            'list']
        self._assert_validation_error(self.user_supplied_feedback,
    ...
    def test_validation_invalid_selected_item_list_fails(self) ->None:
        ...
        self.user_supplied_feedback.user_feedback_selected_items = ['123', 123]
    ...
    def test_validation_valid_text_input_with_empty_selected_items(self
        ) ->None:
        self.user_supplied_feedback.category = CATEGORY_ISSUE_TOPICS
        self.user_supplied_feedback.user_feedback_selected_items = []
        self.user_supplied_feedback.user_feedback_other_text_input = (
    ...
    def _assert_validation_error(self, feedback_obj:
...
class DeviceSystemContextDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        super().setUp()
        self.device_system_context = (app_feedback_report_domain.
            DeviceSystemContext(WEB_PLATFORM_VERSION,
            COUNTRY_LOCALE_CODE_INDIA))

    def test_to_dict(self) ->None:
        expected_dict = {'version_name': WEB_PLATFORM_VERSION,
            'device_country_locale_code': COUNTRY_LOCALE_CODE_INDIA}
        self.assertDictEqual(expected_dict, self.device_system_context.
            to_dict())
...
class AndroidDeviceSystemContextTests(test_utils.GenericTestBase):
    ...
    def test_to_dict(self) ->None:
        expected_dict = {'version_name': ANDROID_PLATFORM_VERSION,
            'package_version_code': ANDROID_PACKAGE_VERSION_CODE,
            'device_country_locale_code': COUNTRY_LOCALE_CODE_INDIA,
            'device_language_locale_code': LANGUAGE_LOCALE_CODE_ENGLISH,
            'device_model': ANDROID_DEVICE_MODEL, 'sdk_version':
            ANDROID_SDK_VERSION, 'build_fingerprint':
            ANDROID_BUILD_FINGERPRINT, 'network_type': NETWORK_WIFI.value}
        self.assertDictEqual(expected_dict, self.device_system_context.
            to_dict())

    def test_validation_version_name_is_none_fails(self) ->None:
        self.device_system_context.version_name = None
        self._assert_validation_error(self.device_system_context,
            'No version name supplied.')

    def test_validation_version_name_is_not_a_string_fails(self) ->None:
        self.device_system_context.version_name = 1
        self._assert_validation_error(self.device_system_context,
            'Version name must be a string')
    ...
    def test_validation_package_version_code_is_none_fails(self) ->None:
        ...
        self._assert_validation_error(self.device_system_context,
            'No package version code supplied.')
    ...
    def test_validation_package_version_code_is_not_an_int_fails(self) ->None:
        ...
        self._assert_validation_error(self.device_system_context,
            'Package version code must be an int')

    def test_validation_package_version_code_less_than_minimum_fails(self
        ) ->None:
        self.device_system_context.package_version_code = (feconf.
            MINIMUM_ANDROID_PACKAGE_VERSION_CODE - 1)
        self._assert_validation_error(self.device_system_context, 
            'The package version code is not a valid int. The minimum supported version is %d'
    ...
    def test_validation_invalid_country_locale_code_fails(self) ->None:
        self.device_system_context.device_country_locale_code = (
            'not a code 123')
        self._assert_validation_error(self.device_system_context,
    ...
    def test_validation_invalid_language_locale_code_fails(self) ->None:
        self.device_system_context.device_language_locale_code = (
            'not a code 12')
        self._assert_validation_error(self.device_system_context,
    ...
    def _assert_validation_error(self, context_obj:
...
class NavigationDrawerEntryPointDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        super().setUp()
        self.entry_point = (app_feedback_report_domain.
            NavigationDrawerEntryPoint())

    def test_to_dict(self) ->None:
        expected_dict = {'entry_point_name': app_feedback_report_constants.
            EntryPoint.NAVIGATION_DRAWER.value}
    ...
    def test_validation_name_is_invalid_fails(self) ->None:
        ...
        with self.assertRaisesRegex(utils.ValidationError, 
            'Expected entry point name %s' % app_feedback_report_constants.
            EntryPoint.NAVIGATION_DRAWER.value):
            self.entry_point.validate()
...
class LessonPlayerEntryPointDomainTests(test_utils.GenericTestBase):
    ...
    def test_to_dict(self) ->None:
        expected_dict = {'entry_point_name': app_feedback_report_constants.
            EntryPoint.LESSON_PLAYER.value, 'topic_id': 'topic_id',
            'story_id': 'story_id', 'exploration_id': 'exploration_id'}
        self.assertDictEqual(expected_dict, self.entry_point.to_dict())

    def test_validation_name_is_none_fails(self) ->None:
        self.entry_point.entry_point_name = None
        self._assert_validation_error(self.entry_point,
            'No entry point name supplied.')
    ...
    def test_validation_name_is_invalid_fails(self) ->None:
        ...
        self._assert_validation_error(self.entry_point, 
            'Expected entry point name %s' % app_feedback_report_constants.
            EntryPoint.LESSON_PLAYER.value)
    ...
    def test_validation_with_valid_story_id(self,
        mock_get_story_id_linked_to_exploration: mock.MagicMock) ->None:
        mock_get_story_id_linked_to_exploration.return_value = 'story_id'
        self.assertIsNone(self.entry_point.
            require_valid_entry_point_exploration(exploration_id=self.
            entry_point.exploration_id, story_id=self.entry_point.story_id))

    def test_entry_point_with_invalid_exploration_id_type(self) ->None:
        self.entry_point.topic_id = 'valid_topic1'
        self.entry_point.story_id = 'valid_story1'
        self.entry_point.exploration_id = 123
        with self.assertRaisesRegex(utils.ValidationError, 
            'Exploration id should be a string, received: %r' % self.
            entry_point.exploration_id):
            self.entry_point.require_valid_entry_point_exploration(
                exploration_id=self.entry_point.exploration_id, story_id=
                self.entry_point.story_id)

    def test_entry_point_with_mismatched_story_id_and_exploration_id(self
        ) ->None:
        self.entry_point.topic_id = 'valid_topic1'
        self.entry_point.story_id = 'valid_story1'
        self.entry_point.exploration_id = 'invalid_exploration'
    ...
    def _assert_validation_error(self, entry_point_obj:
        app_feedback_report_domain.LessonPlayerEntryPoint,
        expected_error_substring: str) ->None:
...
class RevisionCardEntryPointDomainTests(test_utils.GenericTestBase):
    ...
    def test_to_dict(self) ->None:
        expected_dict = {'entry_point_name': app_feedback_report_constants.
            EntryPoint.REVISION_CARD.value, 'topic_id': 'topic_id',
    ...
    def test_validation_name_is_invalid_fails(self) ->None:
        ...
        self._assert_validation_error(self.entry_point, 
            'Expected entry point name %s' % app_feedback_report_constants.
            EntryPoint.REVISION_CARD.value)
    ...
    def test_validation_invalid_subtopic_id_fails(self) ->None:
        ...
        self._assert_validation_error(self.entry_point,
            'Expected subtopic id to be an int')
...
class AppContextDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        ...
        self.app_context = app_feedback_report_domain.AppContext(entry_point,
            LANGUAGE_LOCALE_CODE_ENGLISH, LANGUAGE_LOCALE_CODE_ENGLISH)

    def test_to_dict(self) ->None:
        expected_dict = {'entry_point': {'entry_point_name':
            app_feedback_report_constants.EntryPoint.NAVIGATION_DRAWER.
            value}, 'text_language_code': LANGUAGE_LOCALE_CODE_ENGLISH,
            'audio_language_code': LANGUAGE_LOCALE_CODE_ENGLISH}
...
class AndroidAppContextDomainTests(test_utils.GenericTestBase):
    ...
    def test_validation_event_logs_is_none_fails(self) ->None:
        ...
        self._assert_validation_error(self.app_context,
            'Should have an event log list')

    def test_validation_logcat_logs_is_none_fails(self) ->None:
        self.app_context.logcat_logs = None
        self._assert_validation_error(self.app_context,
            'Should have a logcat log list')

    def _assert_validation_error(self, app_context_obj:
...
class AppFeedbackReportTicketDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        super().setUp()
        self.ticket_id = (app_feedback_report_models.
        ...
        self.ticket_obj = app_feedback_report_domain.AppFeedbackReportTicket(
            self.ticket_id, TICKET_NAME, PLATFORM_ANDROID, None, None, 
            False, REPORT_SUBMITTED_TIMESTAMP, [self.android_report_id])

    def test_to_dict(self) ->None:
        expected_dict = {'ticket_id': self.ticket_id, 'ticket_name':
            TICKET_NAME, 'platform': PLATFORM_ANDROID,
            'github_issue_repo_name': None, 'github_issue_number': None,
            'archived': False, 'newest_report_creation_timestamp_isoformat':
            REPORT_SUBMITTED_TIMESTAMP.isoformat(), 'reports': [self.
            android_report_id]}
    ...
    def test_validation_ticket_id_not_a_string_fails(self) ->None:
        ...
        self._assert_validation_error(self.ticket_obj,
    ...
    def test_validation_ticket_name_too_long_fails(self) ->None:
        long_name = ('too long%s' % 'x' * app_feedback_report_constants.
    ...
    def _assert_validation_error(self, ticket_obj:
...
class AppFeedbackReportDailyStatsDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        ...
        app_feedback_report_models.AppFeedbackReportModel.create(self.
            android_report_id, PLATFORM_ANDROID, REPORT_SUBMITTED_TIMESTAMP,
            0, REPORT_TYPE_SUGGESTION.value, CATEGORY_SUGGESTION_OTHER.
            value, ANDROID_PLATFORM_VERSION, COUNTRY_LOCALE_CODE_INDIA,
            ANDROID_SDK_VERSION, ANDROID_DEVICE_MODEL,
            ENTRY_POINT_NAVIGATION_DRAWER, None, None, None, None,
            LANGUAGE_LOCALE_CODE_ENGLISH, LANGUAGE_LOCALE_CODE_ENGLISH,
            ANDROID_REPORT_INFO, None)
        param_stats = {'platform': app_feedback_report_domain.
            ReportStatsParameterValueCounts({PLATFORM_ANDROID: 1}),
            'report_type': app_feedback_report_domain.
            ReportStatsParameterValueCounts({REPORT_TYPE_SUGGESTION.value: 
            1}), 'country_locale_code': app_feedback_report_domain.
            ReportStatsParameterValueCounts({COUNTRY_LOCALE_CODE_INDIA: 1}),
            'entry_point_name': app_feedback_report_domain.
            ReportStatsParameterValueCounts({ENTRY_POINT_NAVIGATION_DRAWER:
            1}), 'text_language_code': app_feedback_report_domain.
            ReportStatsParameterValueCounts({LANGUAGE_LOCALE_CODE_ENGLISH: 
            1}), 'audio_language_code': app_feedback_report_domain.
            ReportStatsParameterValueCounts({LANGUAGE_LOCALE_CODE_ENGLISH: 
            1}), 'android_sdk_version': app_feedback_report_domain.
            ReportStatsParameterValueCounts({str(ANDROID_SDK_VERSION): 1}),
            'version_name': app_feedback_report_domain.
            ReportStatsParameterValueCounts({ANDROID_PLATFORM_VERSION: 1})}
        self.stats_id = (app_feedback_report_models.
            AppFeedbackReportStatsModel.calculate_id(PLATFORM_ANDROID, self
            .ticket_id, REPORT_SUBMITTED_TIMESTAMP.date()))
        self.stats_obj = (app_feedback_report_domain.
            AppFeedbackReportDailyStats(self.stats_id, self.ticket_obj,
            PLATFORM_ANDROID, REPORT_SUBMITTED_TIMESTAMP, 1, param_stats))

    def test_to_dict(self) ->None:
        expected_dict = {'stats_id': self.stats_id, 'ticket': self.
            ticket_obj.to_dict(), 'platform': PLATFORM_ANDROID,
            'stats_tracking_date': REPORT_SUBMITTED_TIMESTAMP.isoformat(),
            'total_reports_submitted': 1, 'daily_param_stats': {'platform':
            {PLATFORM_ANDROID: 1}, 'report_type': {REPORT_TYPE_SUGGESTION.
            value: 1}, 'country_locale_code': {COUNTRY_LOCALE_CODE_INDIA: 1
    ...
    def test_validation_stats_id_is_not_a_string_fails(self) ->None:
        ...
        self._assert_validation_error(self.stats_obj,
            'The stats id should be a string')

    def test_validation_invalid_id_fails(self) ->None:
        self.stats_obj.stats_id = 'invalid_stats_id'
        self._assert_validation_error(self.stats_obj, 
            'The stats id %s is invalid' % 'invalid_stats_id')
    ...
    def test_validation_invalid_daily_param_stats_fails(self) ->None:
        self.stats_obj.daily_param_stats = {'invalid_stat_name':
    ...
    def test_validation_parameter_value_counts_objects_are_invalid_fails(self
        ...
        self.stats_obj.daily_param_stats = {'report_type':
            app_feedback_report_domain.ReportStatsParameterValueCounts({(
            123): 1})}
        self._assert_validation_error(self.stats_obj,
            'The parameter value should be a string')

    def _assert_validation_error(self, stats_obj:
...
class ReportStatsParameterValueCountsDomainTests(test_utils.GenericTestBase):
    ...
    def test_to_dict(self) ->None:
        counts_obj = (app_feedback_report_domain.
            ReportStatsParameterValueCounts({PLATFORM_ANDROID: 1,
            PLATFORM_WEB: 1}))
    ...
    def test_validation_with_invalid_parameter_value_fails(self) ->None:
        counts_obj = (app_feedback_report_domain.
            ReportStatsParameterValueCounts({(1): 1, (2): 1}))
        self._assert_validation_error(counts_obj,
            'The parameter value should be a string')

    def test_validation_with_invalid_parameter_counts_fails(self) ->None:
        counts_obj = (app_feedback_report_domain.
            ReportStatsParameterValueCounts({'value_1': -1}))
        self._assert_validation_error(counts_obj,
            'The parameter value count should be a non-negative int')

    def _assert_validation_error(self, counts_obj:
        app_feedback_report_domain.ReportStatsParameterValueCounts,
        expected_error_substring: str) ->None:
...
class AppFeedbackReportFilterDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        ...
        self.filter = app_feedback_report_domain.AppFeedbackReportFilter(
            app_feedback_report_constants.FilterFieldNames.PLATFORM, ['web',
            'android'])

    def test_to_dict(self) ->None:
        app_feedback_report_constants.PLATFORM_CHOICES.sort()
        expected_dict = {'filter_field': 'PLATFORM', 'filter_options':
    ...
    def test_validation_with_invalid_filter_field_fails(self) ->None:
        ...
        self._assert_validation_error(self.filter,
    ...
    def _assert_validation_error(self, filter_obj:
