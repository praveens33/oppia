...
def _send_email(recipient_id: str, sender_id: str, intent: str,
    ...
    str]=None, attachments: Optional[List[Dict[str, str]]]=None) ->None:
...
"""
    ...
    def _send_email_transactional() ->None:
        ...
        email_services.send_mail(sender_name_email, recipient_email_address,
        ...
        email_models.SentEmailModel.create(recipient_id,
            recipient_email_address, sender_id, sender_name_email, intent,
...
def _send_bulk_mail(recipient_ids: List[str], sender_id: str, intent: str,
    ...
    sender_name: str, instance_id: str, attachments: Optional[List[Dict[str,
    str]]]=None) ->None:
...
"""
    ...
    def _send_bulk_mail_transactional(instance_id: str) ->None:
        ...
        email_services.send_bulk_mail(sender_name_email, recipient_emails,
            email_subject, cleaned_plaintext_body, cleaned_html_body,
            attachments)
        email_models.BulkEmailModel.create(instance_id, sender_id,
            sender_name_email, intent, email_subject, cleaned_html_body,
