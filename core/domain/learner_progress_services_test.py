...
class LearnerProgressTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        ...
        self.save_new_valid_exploration(self.EXP_ID_2, self.user_id, title=
        ...
        self.save_new_default_collection(self.COL_ID_0, self.owner_id,
            title='Bridges', category='Architecture')
        ...
        self.save_new_default_collection(self.COL_ID_2, self.user_id, title
        ...
        self.save_new_default_collection(self.COL_ID_3, self.owner_id,
            title='Welcome Oppia Collection', category='Welcome')
        self.publish_collection(self.owner_id, self.COL_ID_3)
        topic = topic_domain.Topic.create_default_topic(self.TOPIC_ID_0,
            'topic', 'abbrev', 'description', 'fragm')
        ...
        topic.subtopics = [topic_domain.Subtopic(1, 'Title', ['skill_id_1'],
            ...
            0], 21131, 'dummy-subtopic-url')]
        topic.next_subtopic_id = 2
        topic.skill_ids_for_diagnostic_test = ['skill_id_1']
        subtopic_page = (subtopic_page_domain.SubtopicPage.
            create_default_subtopic_page(1, self.TOPIC_ID_0))
        subtopic_page_services.save_subtopic_page(self.owner_id,
            subtopic_page, 'Added subtopic', [topic_domain.TopicChange({
            'cmd': topic_domain.CMD_ADD_SUBTOPIC, 'subtopic_id': 1, 'title':
            'Sample', 'url_fragment': 'dummy-fragment'})])
        topic_services.save_new_topic(self.owner_id, topic)
        self.save_new_story(self.STORY_ID_0, self.owner_id, self.TOPIC_ID_0)
        topic_services.add_canonical_story(self.owner_id, self.TOPIC_ID_0,
            self.STORY_ID_0)
        changelist = [story_domain.StoryChange({'cmd': story_domain.
            CMD_ADD_STORY_NODE, 'node_id': 'node_1', 'title': 'Title 1'}),
            story_domain.StoryChange({'cmd': story_domain.
            CMD_UPDATE_STORY_NODE_PROPERTY, 'property_name': story_domain.
            STORY_NODE_PROPERTY_EXPLORATION_ID, 'old_value': None,
            'new_value': self.EXP_ID_4, 'node_id': 'node_1'})]
        story_services.update_story(self.owner_id, self.STORY_ID_0,
            changelist, 'Added node.')
        topic = topic_domain.Topic.create_default_topic(self.TOPIC_ID_1,
            'topic 1', 'abbrev-one', 'description 1', 'fragm')
        topic.thumbnail_filename = 'thumbnail.svg'
        topic.thumbnail_bg_color = '#C6DCDA'
        topic.subtopics = [topic_domain.Subtopic(1, 'Title 1', [
            'skill_id_1'], 'image.svg', constants.
            ALLOWED_THUMBNAIL_BG_COLORS['subtopic'][0], 21131,
            'dummy-subtopic-url-one')]
        topic.next_subtopic_id = 2
        topic.skill_ids_for_diagnostic_test = ['skill_id_1']
        subtopic_page = (subtopic_page_domain.SubtopicPage.
            create_default_subtopic_page(1, self.TOPIC_ID_1))
        subtopic_page_services.save_subtopic_page(self.owner_id,
            subtopic_page, 'Added subtopic', [topic_domain.TopicChange({
            'cmd': topic_domain.CMD_ADD_SUBTOPIC, 'subtopic_id': 1, 'title':
            'Sample', 'url_fragment': 'fragment'})])
        topic_services.save_new_topic(self.owner_id, topic)
        ...
        changelist = [story_domain.StoryChange({'cmd': story_domain.
            ...
            CMD_UPDATE_STORY_NODE_PROPERTY, 'property_name': story_domain.
            STORY_NODE_PROPERTY_EXPLORATION_ID, 'old_value': None,
            'new_value': self.EXP_ID_5, 'node_id': 'node_1'})]
        story_services.update_story(self.owner_id, self.STORY_ID_1,
            changelist, 'Added Node 1.')
        topic = topic_domain.Topic.create_default_topic(self.TOPIC_ID_2,
            'topic 2', 'abbrev-two', 'description 2', 'fragm')
        topic.thumbnail_filename = 'thumbnail.svg'
        topic.thumbnail_bg_color = '#C6DCDA'
        topic.subtopics = [topic_domain.Subtopic(1, 'Title 1', [
            'skill_id_1'], 'image.svg', constants.
        ...
        topic.skill_ids_for_diagnostic_test = ['skill_id_1']
        subtopic_page = (subtopic_page_domain.SubtopicPage.
            create_default_subtopic_page(1, self.TOPIC_ID_2))
        subtopic_page_services.save_subtopic_page(self.owner_id,
            subtopic_page, 'Added subtopic', [topic_domain.TopicChange({
            'cmd': topic_domain.CMD_ADD_SUBTOPIC, 'subtopic_id': 1, 'title':
            'Sample', 'url_fragment': 'sample-fragment'})])
        topic_services.save_new_topic(self.owner_id, topic)
        ...
        topic_services.add_canonical_story(self.owner_id, self.TOPIC_ID_2,
            self.STORY_ID_2)
        topic = topic_domain.Topic.create_default_topic(self.TOPIC_ID_3,
            'topic 3', 'abbrev-three', 'description 3', 'fragm')
        topic.thumbnail_filename = 'thumbnail.svg'
        topic.thumbnail_bg_color = '#C6DCDA'
        topic.subtopics = [topic_domain.Subtopic(1, 'Title 1', [
            'skill_id_1'], 'image.svg', constants.
        ...
        topic.skill_ids_for_diagnostic_test = ['skill_id_1']
        subtopic_page = (subtopic_page_domain.SubtopicPage.
            create_default_subtopic_page(1, self.TOPIC_ID_3))
        subtopic_page_services.save_subtopic_page(self.owner_id,
            subtopic_page, 'Added subtopic', [topic_domain.TopicChange({
            'cmd': topic_domain.CMD_ADD_SUBTOPIC, 'subtopic_id': 1, 'title':
            'Sample', 'url_fragment': 'sample-fragment'})])
        ...
        topic_services.add_canonical_story(self.owner_id, self.TOPIC_ID_3,
            self.STORY_ID_3)
        topic_services.publish_story(self.TOPIC_ID_0, self.STORY_ID_0, self
            .admin_id)
        topic_services.publish_topic(self.TOPIC_ID_0, self.admin_id)
        topic_services.publish_story(self.TOPIC_ID_1, self.STORY_ID_1, self
            .admin_id)
        topic_services.publish_topic(self.TOPIC_ID_1, self.admin_id)
        topic_services.publish_story(self.TOPIC_ID_2, self.STORY_ID_2, self
            .admin_id)
        topic_services.publish_topic(self.TOPIC_ID_2, self.admin_id)
        topic_services.publish_story(self.TOPIC_ID_3, self.STORY_ID_3, self
            .admin_id)
    ...
    def _get_all_incomplete_exp_ids(self, user_id: str) ->List[str]:
        ...
        """
        incomplete_activities_model = (user_models.
            IncompleteActivitiesModel.get(user_id, strict=False))
    ...
    def _get_incomplete_exp_details(self, user_id: str, exploration_id: str
        ...
        """
        incomplete_exploration_user_model = (user_models.
            ExpUserLastPlaythroughModel.get(user_id, exploration_id))
        assert incomplete_exploration_user_model is not None
        return {'timestamp': incomplete_exploration_user_model.last_updated,
            'state_name': incomplete_exploration_user_model.
            last_played_state_name, 'version':
            incomplete_exploration_user_model.last_played_exp_version}

    def _check_if_exp_details_match(self, actual_details:
        IncompleteExplorationDetailsDict, details_fetched_from_model:
        IncompleteExplorationDetailsDict) ->None:
        """Verifies the exploration details fetched from the model matches the
        actual details.
        """
        self.assertEqual(actual_details['state_name'],
            details_fetched_from_model['state_name'])
        self.assertEqual(actual_details['version'],
            details_fetched_from_model['version'])
        self.assertLess((actual_details['timestamp'] -
    ...
    def test_mark_exploration_as_completed(self) ->None:
        ...
        learner_progress_services.mark_exploration_as_completed(self.
            user_id, self.EXP_ID_0)
        self.assertEqual(self._get_all_completed_exp_ids(self.user_id), [
            self.EXP_ID_0])
        learner_progress_services.mark_exploration_as_completed(self.
            user_id, self.EXP_ID_0)
        ...
        learner_progress_services.mark_exploration_as_incomplete(self.
            user_id, self.EXP_ID_1, state_name, version)
        self.assertEqual(self._get_all_incomplete_exp_ids(self.user_id), [
            self.EXP_ID_1])
        learner_playlist_services.mark_exploration_to_be_played_later(self.
            user_id, self.EXP_ID_3)
        self.assertEqual(learner_playlist_services.
            get_all_exp_ids_in_learner_playlist(self.user_id), [self.EXP_ID_3])
        learner_progress_services.mark_exploration_as_completed(self.
            user_id, self.EXP_ID_1)
        self.assertEqual(self._get_all_completed_exp_ids(self.user_id), [
        ...
        self.assertEqual(learner_playlist_services.
            get_all_exp_ids_in_learner_playlist(self.user_id), [])
        learner_progress_services.mark_exploration_as_completed(self.
            user_id, self.EXP_ID_2)
        self.assertEqual(self._get_all_completed_exp_ids(self.user_id), [
            self.EXP_ID_0, self.EXP_ID_1, self.EXP_ID_3])

    def test_mark_collection_as_completed(self) ->None:
        self.assertEqual(self._get_all_completed_collection_ids(self.
            user_id), [])
        learner_progress_services.mark_collection_as_completed(self.user_id,
            self.COL_ID_0)
        self.assertEqual(self._get_all_completed_collection_ids(self.
            user_id), [self.COL_ID_0])
        learner_progress_services.mark_collection_as_completed(self.user_id,
            self.COL_ID_0)
        self.assertEqual(self._get_all_completed_collection_ids(self.
            user_id), [self.COL_ID_0])
        learner_progress_services.mark_collection_as_incomplete(self.
            user_id, self.COL_ID_1)
        self.assertEqual(self._get_all_incomplete_collection_ids(self.
            user_id), [self.COL_ID_1])
        learner_progress_services.mark_collection_as_completed(self.user_id,
            self.COL_ID_1)
        self.assertEqual(self._get_all_incomplete_collection_ids(self.
            user_id), [])
        self.assertEqual(self._get_all_completed_collection_ids(self.
            user_id), [self.COL_ID_0, self.COL_ID_1])
        learner_playlist_services.mark_collection_to_be_played_later(self.
            user_id, self.COL_ID_3)
        self.assertEqual(learner_playlist_services.
            get_all_collection_ids_in_learner_playlist(self.user_id), [self
            .COL_ID_3])
        learner_progress_services.mark_collection_as_completed(self.user_id,
            self.COL_ID_3)
        self.assertEqual(self._get_all_completed_collection_ids(self.
            user_id), [self.COL_ID_0, self.COL_ID_1, self.COL_ID_3])
        self.assertEqual(learner_playlist_services.
            get_all_collection_ids_in_learner_playlist(self.user_id), [])
        learner_progress_services.mark_collection_as_completed(self.user_id,
            self.COL_ID_2)
        self.assertEqual(self._get_all_completed_collection_ids(self.
            user_id), [self.COL_ID_0, self.COL_ID_1, self.COL_ID_3])
    ...
    def test_mark_story_as_completed(self) ->None:
        ...
        learner_progress_services.mark_story_as_completed(self.user_id,
            self.STORY_ID_0)
        self.assertEqual(self._get_all_completed_story_ids(self.user_id), [
            self.STORY_ID_0])
        learner_progress_services.mark_story_as_completed(self.user_id,
        ...
        self.assertEqual(self._get_all_completed_story_ids(self.user_id), [
            self.STORY_ID_0])
        learner_progress_services.record_story_started(self.user_id, self.
            STORY_ID_1)
    ...
    def test_mark_topic_as_learnt(self) ->None:
        ...
        learner_progress_services.mark_topic_as_learnt(self.user_id, self.
            TOPIC_ID_0)
        self.assertEqual(self._get_all_learnt_topic_ids(self.user_id), [
            self.TOPIC_ID_0])
        learner_progress_services.mark_topic_as_learnt(self.user_id, self.
        ...
        self.assertEqual(self._get_all_learnt_topic_ids(self.user_id), [
            self.TOPIC_ID_0])
        learner_progress_services.record_topic_started(self.user_id, self.
            TOPIC_ID_1)
        self.assertEqual(self._get_all_partially_learnt_topic_ids(self.
            user_id), [self.TOPIC_ID_1])
        learner_progress_services.mark_topic_as_learnt(self.user_id, self.
            TOPIC_ID_1)
        self.assertEqual(self._get_all_partially_learnt_topic_ids(self.
            user_id), [])
        ...
        learner_progress_services.validate_and_add_topic_to_learn_goal(self
            .user_id, self.TOPIC_ID_2)
        self.assertEqual(learner_goals_services.get_all_topic_ids_to_learn(
    ...
    def test_mark_exploration_as_incomplete(self) ->None:
        ...
        version = 1
        exp_details: IncompleteExplorationDetailsDict = {'timestamp':
            get_current_datetime_utc(), 'state_name': state_name, 'version':
            version}
        learner_progress_services.mark_exploration_as_incomplete(self.
            user_id, self.EXP_ID_0, state_name, version)
        self.assertEqual(self._get_all_incomplete_exp_ids(self.user_id), [
            self.EXP_ID_0])
        self._check_if_exp_details_match(self._get_incomplete_exp_details(
            self.user_id, self.EXP_ID_0), exp_details)
        state_name = 'new_state_name'
        version = 2
        modified_exp_details: IncompleteExplorationDetailsDict = {'timestamp':
            get_current_datetime_utc(), 'state_name': state_name, 'version':
            version}
        learner_progress_services.mark_exploration_as_incomplete(self.
            user_id, self.EXP_ID_0, state_name, version)
        ...
        self.assertEqual(learner_playlist_services.
            get_all_exp_ids_in_learner_playlist(self.user_id), [self.EXP_ID_3])
        learner_progress_services.mark_exploration_as_incomplete(self.
            user_id, self.EXP_ID_3, state_name, version)
        self.assertEqual(self._get_all_incomplete_exp_ids(self.user_id), [
            self.EXP_ID_0, self.EXP_ID_3])
        self.assertEqual(learner_playlist_services.
            get_all_exp_ids_in_learner_playlist(self.user_id), [])
        learner_progress_services.mark_exploration_as_incomplete(self.
            user_id, self.EXP_ID_2, state_name, version)
        self.assertEqual(self._get_all_incomplete_exp_ids(self.user_id), [
            self.EXP_ID_0, self.EXP_ID_3])
    ...
    def test_mark_collection_as_incomplete(self) ->None:
        ...
        learner_progress_services.mark_collection_as_incomplete(self.
            user_id, self.COL_ID_3)
        self.assertEqual(self._get_all_incomplete_collection_ids(self.
            user_id), [self.COL_ID_0, self.COL_ID_3])
        self.assertEqual(learner_playlist_services.
            get_all_collection_ids_in_learner_playlist(self.user_id), [])
        learner_progress_services.mark_collection_as_incomplete(self.
            user_id, self.COL_ID_2)
        self.assertEqual(self._get_all_incomplete_collection_ids(self.
            user_id), [self.COL_ID_0, self.COL_ID_3])
    ...
    def test_remove_exp_from_incomplete_list(self) ->None:
        ...
        self.assertEqual(self._get_all_incomplete_exp_ids(self.user_id), [
            self.EXP_ID_0, self.EXP_ID_1])
        learner_progress_services.remove_exp_from_incomplete_list(self.
            user_id, self.EXP_ID_0)
        self.assertEqual(self._get_all_incomplete_exp_ids(self.user_id), [
            self.EXP_ID_1])
        learner_progress_services.remove_exp_from_incomplete_list(self.
    ...
    def test_remove_collection_from_incomplete_list(self) ->None:
        ...
        self.assertEqual(self._get_all_incomplete_collection_ids(self.
            user_id), [self.COL_ID_0, self.COL_ID_1])
        learner_progress_services.remove_collection_from_incomplete_list(self
            .user_id, self.COL_ID_0)
        self.assertEqual(self._get_all_incomplete_collection_ids(self.
            user_id), [self.COL_ID_1])
        learner_progress_services.remove_collection_from_incomplete_list(self
    ...
    def test_remove_story_from_incomplete_list(self) ->None:
        ...
        self.assertEqual(self._get_all_incomplete_story_ids(self.user_id),
            [self.STORY_ID_0, self.STORY_ID_1])
        learner_progress_services.remove_story_from_incomplete_list(self.
            user_id, self.STORY_ID_0)
        self.assertEqual(self._get_all_incomplete_story_ids(self.user_id),
            [self.STORY_ID_1])
        learner_progress_services.remove_story_from_incomplete_list(self.
            user_id, self.STORY_ID_0)
    ...
    def test_remove_topic_from_partially_learnt_list(self) ->None:
        ...
        learner_progress_services.record_topic_started(self.user_id, self.
            TOPIC_ID_1)
        self.assertEqual(self._get_all_partially_learnt_topic_ids(self.
            user_id), [self.TOPIC_ID_0, self.TOPIC_ID_1])
        learner_progress_services.remove_topic_from_partially_learnt_list(self
            .user_id, self.TOPIC_ID_0)
        self.assertEqual(self._get_all_partially_learnt_topic_ids(self.
            user_id), [self.TOPIC_ID_1])
        learner_progress_services.remove_topic_from_partially_learnt_list(self
    ...
    def test_remove_story_from_completed_list(self) ->None:
        ...
        self.assertEqual(self._get_all_completed_story_ids(self.user_id), [
            self.STORY_ID_0, self.STORY_ID_1])
        learner_progress_services.remove_story_from_completed_list(self.
            user_id, self.STORY_ID_0)
        self.assertEqual(self._get_all_completed_story_ids(self.user_id), [
            self.STORY_ID_1])
        learner_progress_services.remove_story_from_completed_list(self.
    ...
    def test_remove_topic_from_learnt_list(self) ->None:
        ...
        self.assertEqual(self._get_all_learnt_topic_ids(self.user_id), [
            self.TOPIC_ID_0, self.TOPIC_ID_1])
        learner_progress_services.remove_topic_from_learnt_list(self.
            user_id, self.TOPIC_ID_0)
        self.assertEqual(self._get_all_learnt_topic_ids(self.user_id), [
            self.TOPIC_ID_1])
        learner_progress_services.remove_topic_from_learnt_list(self.
    ...
    def test_get_all_completed_exp_ids(self) ->None:
        self.assertEqual(learner_progress_services.
            get_all_completed_exp_ids(self.user_id), [])
        learner_progress_services.mark_exploration_as_completed(self.
            user_id, self.EXP_ID_0)
        self.assertEqual(learner_progress_services.
            get_all_completed_exp_ids(self.user_id), [self.EXP_ID_0])
        learner_progress_services.mark_exploration_as_completed(self.
            user_id, self.EXP_ID_1)
        self.assertEqual(learner_progress_services.
            get_all_completed_exp_ids(self.user_id), [self.EXP_ID_0, self.
            EXP_ID_1])
    ...
    def test_unpublishing_completed_exploration_filters_it_out(self) ->None:
        ...
        self.assertEqual(learner_progress_services.
            get_all_completed_exp_ids(self.user_id), [self.EXP_ID_0, self.
            EXP_ID_1, self.EXP_ID_3])
        system_user = user_services.get_system_user()
        rights_manager.unpublish_exploration(system_user, self.EXP_ID_3)
        private_exploration = exp_fetchers.get_exploration_summary_by_id(self
            .EXP_ID_3)
        self.assertEqual(private_exploration.status, constants.
            ACTIVITY_STATUS_PRIVATE)
        user_activity = learner_progress_services.get_exploration_progress(self
            .user_id)
        all_filtered_summaries = user_activity[0]
        completed_exp_summaries = (all_filtered_summaries.
    ...
    def test_republishing_completed_exploration_filters_as_complete(self
        ...
        learner_progress_services.mark_exploration_as_completed(self.
            user_id, self.EXP_ID_0)
        public_exploration = exp_fetchers.get_exploration_summary_by_id(self
            .EXP_ID_0)
        self.assertEqual(public_exploration.status, constants.
    ...
    def test_get_all_completed_collection_ids(self) ->None:
        self.assertEqual(learner_progress_services.
            get_all_completed_collection_ids(self.user_id), [])
        learner_progress_services.mark_collection_as_completed(self.user_id,
            self.COL_ID_0)
        self.assertEqual(learner_progress_services.
            get_all_completed_collection_ids(self.user_id), [self.COL_ID_0])
        learner_progress_services.mark_collection_as_completed(self.user_id,
            self.COL_ID_1)
        self.assertEqual(learner_progress_services.
            get_all_completed_collection_ids(self.user_id), [self.COL_ID_0,
    ...
    def test_get_all_completed_story_ids(self) ->None:
        self.assertEqual(learner_progress_services.
            get_all_completed_story_ids(self.user_id), [])
        learner_progress_services.mark_story_as_completed(self.user_id,
            self.STORY_ID_0)
        self.assertEqual(learner_progress_services.
            get_all_completed_story_ids(self.user_id), [self.STORY_ID_0])
        learner_progress_services.mark_story_as_completed(self.user_id,
            self.STORY_ID_1)
        self.assertEqual(learner_progress_services.
            get_all_completed_story_ids(self.user_id), [self.STORY_ID_0,
    ...
    def test_get_all_learnt_topic_ids(self) ->None:
        self.assertEqual(learner_progress_services.get_all_learnt_topic_ids
            (self.user_id), [])
        learner_progress_services.mark_topic_as_learnt(self.user_id, self.
            TOPIC_ID_0)
        self.assertEqual(learner_progress_services.get_all_learnt_topic_ids
    ...
    def test_unpublishing_completed_collection_filters_it_out(self) ->None:
        ...
        self.assertEqual(private_collection.status, constants.
            ACTIVITY_STATUS_PRIVATE)
        user_activity = learner_progress_services.get_collection_progress(self
            .user_id)
        all_filtered_summaries = user_activity[0]
        completed_collection_summaries = (all_filtered_summaries.
            completed_collection_summaries)
        self.assertEqual(completed_collection_summaries[0].id,
            '0_arch_bridges_in_england')
        self.assertEqual(completed_collection_summaries[1].id,
            '1_welcome_introduce_oppia')
    ...
    def test_republishing_completed_collection_filters_as_complete(self
        ...
        self.assertEqual(public_collection.status, constants.
            ACTIVITY_STATUS_PUBLIC)
        user_activity = learner_progress_services.get_collection_progress(self
            .user_id)
        all_filtered_summaries = user_activity[0]
    ...
    def test_unpublishing_completed_story_filters_it_out(self) ->None:
        story_services.record_completed_node_in_story_context(self.user_id,
            self.STORY_ID_0, 'node_1')
        learner_progress_services.mark_story_as_completed(self.user_id,
            self.STORY_ID_0)
        story_services.record_completed_node_in_story_context(self.user_id,
            self.STORY_ID_1, 'node_1')
        learner_progress_services.mark_story_as_completed(self.user_id,
            self.STORY_ID_1)
        self.assertEqual(learner_progress_services.
            get_all_completed_story_ids(self.user_id), [self.STORY_ID_0,
            self.STORY_ID_1])
        topic_services.unpublish_story(self.TOPIC_ID_1, self.STORY_ID_1,
            self.admin_id)
        user_activity = (learner_progress_services.
            get_topics_and_stories_progress(self.user_id))
        all_filtered_summaries = user_activity[0]
        completed_story_summaries = (all_filtered_summaries.
    ...
    def test_get_all_incomplete_exp_ids(self) ->None:
        self.assertEqual(learner_progress_services.
            get_all_incomplete_exp_ids(self.user_id), [])
        state_name = 'state name'
        version = 1
        learner_progress_services.mark_exploration_as_incomplete(self.
            user_id, self.EXP_ID_0, state_name, version)
        self.assertEqual(learner_progress_services.
            get_all_incomplete_exp_ids(self.user_id), [self.EXP_ID_0])
        learner_progress_services.mark_exploration_as_incomplete(self.
            user_id, self.EXP_ID_1, state_name, version)
        self.assertEqual(learner_progress_services.
            get_all_incomplete_exp_ids(self.user_id), [self.EXP_ID_0, self.
            EXP_ID_1])
    ...
    def test_unpublishing_incomplete_exploration_filters_it_out(self) ->None:
        ...
        user_activity = learner_progress_services.get_exploration_progress(self
            .user_id)
        all_filtered_summaries = user_activity[0]
        incomplete_exp_summaries = (all_filtered_summaries.
    ...
    def test_get_all_incomplete_collection_ids(self) ->None:
        self.assertEqual(learner_progress_services.
            get_all_incomplete_collection_ids(self.user_id), [])
        learner_progress_services.mark_collection_as_incomplete(self.
            user_id, self.COL_ID_0)
        self.assertEqual(learner_progress_services.
            get_all_incomplete_collection_ids(self.user_id), [self.COL_ID_0])
        learner_progress_services.mark_collection_as_incomplete(self.
            user_id, self.COL_ID_1)
        self.assertEqual(learner_progress_services.
            get_all_incomplete_collection_ids(self.user_id), [self.COL_ID_0,
    ...
    def test_get_all_incomplete_story_ids(self) ->None:
        self.assertEqual(learner_progress_services.
            get_all_incomplete_story_ids(self.user_id), [])
        learner_progress_services.record_story_started(self.user_id, self.
            STORY_ID_0)
        self.assertEqual(learner_progress_services.
            get_all_incomplete_story_ids(self.user_id), [self.STORY_ID_0])
        learner_progress_services.record_story_started(self.user_id, self.
            STORY_ID_1)
        self.assertEqual(learner_progress_services.
            get_all_incomplete_story_ids(self.user_id), [self.STORY_ID_0,
    ...
    def test_get_all_partially_learnt_topic_ids(self) ->None:
        self.assertEqual(learner_progress_services.
            get_all_partially_learnt_topic_ids(self.user_id), [])
        learner_progress_services.record_topic_started(self.user_id, self.
            TOPIC_ID_0)
        self.assertEqual(learner_progress_services.
            get_all_partially_learnt_topic_ids(self.user_id), [self.TOPIC_ID_0]
            )
        learner_progress_services.record_topic_started(self.user_id, self.
            TOPIC_ID_1)
        self.assertEqual(learner_progress_services.
            get_all_partially_learnt_topic_ids(self.user_id), [self.
            TOPIC_ID_0, self.TOPIC_ID_1])

    def test_get_all_and_untracked_topic_ids(self) ->None:
        self.save_new_valid_classroom(topic_id_to_prerequisite_topic_ids={
            self.TOPIC_ID_0: [], self.TOPIC_ID_1: []})
        self.save_new_valid_classroom(is_published=False, name='History',
            url_fragment='history', classroom_id='historyid')
        self.login(self.USER_EMAIL)
        partially_learnt_topic_ids = (learner_progress_services.
            get_all_partially_learnt_topic_ids(self.user_id))
        ...
        topic_ids_to_learn = learner_goals_services.get_all_topic_ids_to_learn(
            self.user_id)
        all_topics, untracked_topics = (learner_progress_services.
        ...
        all_topics, untracked_topics = (learner_progress_services.
            get_all_and_untracked_topic_ids_for_user(
            partially_learnt_topic_ids, learnt_topic_ids, topic_ids_to_learn))
        untracked_topic_summary_dicts = (learner_progress_services.
            get_displayable_untracked_topic_summary_dicts(self.user_id,
    ...
    def test_unpublishing_incomplete_collection_filters_it_out(self) ->None:
        ...
        user_activity = learner_progress_services.get_collection_progress(self
            .user_id)
        all_filtered_summaries = user_activity[0]
        incomplete_collection_summaries = (all_filtered_summaries.
    ...
    def test_unpublishing_partially_learnt_topic_filters_it_out(self) ->None:
        ...
        user_activity = (learner_progress_services.
            get_topics_and_stories_progress(self.user_id))
        all_filtered_summaries = user_activity[0]
        partially_learnt_topic_summaries = (all_filtered_summaries.
            partially_learnt_topic_summaries)
        self.assertEqual(partially_learnt_topic_summaries[0].id, self.
            TOPIC_ID_0)
    ...
    def test_unpublishing_exploration_filters_it_out_from_playlist(self
        ...
        learner_progress_services.add_exp_to_learner_playlist(self.user_id,
            self.EXP_ID_0)
        learner_progress_services.add_exp_to_learner_playlist(self.user_id,
            self.EXP_ID_1)
        self.assertEqual(learner_playlist_services.
            get_all_exp_ids_in_learner_playlist(self.user_id), [self.
            EXP_ID_0, self.EXP_ID_1])
        system_user = user_services.get_system_user()
        ...
        user_activity = learner_progress_services.get_exploration_progress(self
            .user_id)
        all_filtered_summaries = user_activity[0]
        exploration_playlist = (all_filtered_summaries.
            exploration_playlist_summaries)
        self.assertEqual(exploration_playlist[0].id,
            '0_en_arch_bridges_in_england')
    ...
    def test_republishing_exploration_keeps_it_in_exploration_playlist(self
        ...
        learner_progress_services.add_exp_to_learner_playlist(self.user_id,
            self.EXP_ID_0)
        self.assertEqual(learner_playlist_services.
            get_all_exp_ids_in_learner_playlist(self.user_id), [self.EXP_ID_0])
        system_user = user_services.get_system_user()
        rights_manager.unpublish_exploration(system_user, self.EXP_ID_0)
        private_exploration = exp_fetchers.get_exploration_summary_by_id(self
            .EXP_ID_0)
    ...
    def test_unpublishing_collection_filters_it_out_from_playlist(self) ->None:
        learner_progress_services.add_collection_to_learner_playlist(self.
            user_id, self.COL_ID_0)
        learner_progress_services.add_collection_to_learner_playlist(self.
            user_id, self.COL_ID_1)
        self.assertEqual(learner_playlist_services.
            get_all_collection_ids_in_learner_playlist(self.user_id), [self
            .COL_ID_0, self.COL_ID_1])
        system_user = user_services.get_system_user()
        ...
        user_activity = learner_progress_services.get_collection_progress(self
            .user_id)
        all_filtered_summaries = user_activity[0]
        collection_playlist = (all_filtered_summaries.
    ...
    def test_get_ids_of_activities_in_learner_dashboard(self) ->None:
        ...
        learner_progress_services.validate_and_add_topic_to_learn_goal(self
            .user_id, self.TOPIC_ID_2)
        activity_ids = (learner_progress_services.
            get_learner_dashboard_activities(self.user_id))
        self.assertEqual(activity_ids.completed_exploration_ids, [self.
            EXP_ID_0])
        ...
        self.assertEqual(activity_ids.incomplete_exploration_ids, [self.
            EXP_ID_1])
        self.assertEqual(activity_ids.incomplete_collection_ids, [self.
            COL_ID_1])
        self.assertEqual(activity_ids.partially_learnt_topic_ids, [self.
            TOPIC_ID_1])
    ...
    def test_get_all_activity_progress(self) ->None:
        ...
        learner_progress_services.validate_and_add_topic_to_learn_goal(self
            .user_id, self.TOPIC_ID_2)
        exploration_progress = (learner_progress_services.
            get_exploration_progress(self.user_id))
        collection_progress = (learner_progress_services.
            get_collection_progress(self.user_id))
        topics_and_stories_progress = (learner_progress_services.
            get_topics_and_stories_progress(self.user_id))
        incomplete_exp_summaries = exploration_progress[0
            ].incomplete_exp_summaries
        incomplete_collection_summaries = collection_progress[0
            ].incomplete_collection_summaries
        partially_learnt_topic_summaries = topics_and_stories_progress[0
            ].partially_learnt_topic_summaries
        completed_exp_summaries = exploration_progress[0
            ].completed_exp_summaries
        completed_collection_summaries = collection_progress[0
            ].completed_collection_summaries
        completed_story_summaries = topics_and_stories_progress[0
            ].completed_story_summaries
        learnt_topic_summaries = topics_and_stories_progress[0
            ].learnt_topic_summaries
        topics_to_learn_summaries = topics_and_stories_progress[0
            ].topics_to_learn_summaries
        all_topic_summaries = topics_and_stories_progress[0
            ].all_topic_summaries
        untracked_topic_summaries = topics_and_stories_progress[0
            ].untracked_topic_summaries
        exploration_playlist_summaries = exploration_progress[0
            ].exploration_playlist_summaries
        collection_playlist_summaries = collection_progress[0
            ].collection_playlist_summaries
        self.assertEqual(len(incomplete_exp_summaries), 1)
        self.assertEqual(len(incomplete_collection_summaries), 1)
        self.assertEqual(len(partially_learnt_topic_summaries), 1)
        ...
        collection_services.update_collection(self.owner_id, self.COL_ID_0,
            [{'cmd': collection_domain.CMD_ADD_COLLECTION_NODE,
            'exploration_id': self.EXP_ID_2}], 'Add new exploration')
        topic_services.delete_topic(self.owner_id, self.TOPIC_ID_2)
        changelist = [story_domain.StoryChange({'cmd': story_domain.
            CMD_ADD_STORY_NODE, 'node_id': 'node_2', 'title': 'Title 2'}),
            story_domain.StoryChange({'cmd': story_domain.
            CMD_UPDATE_STORY_NODE_PROPERTY, 'property_name': story_domain.
            STORY_NODE_PROPERTY_EXPLORATION_ID, 'old_value': None,
            'new_value': self.EXP_ID_6, 'node_id': 'node_2'})]
        story_services.update_story(self.owner_id, self.STORY_ID_0,
            changelist, 'Added node.')
        exploration_progress = (learner_progress_services.
            get_exploration_progress(self.user_id))
        ...
        topics_and_stories_progress = (learner_progress_services.
            get_topics_and_stories_progress(self.user_id))
        self.assertEqual(len(exploration_progress[0].
            incomplete_exp_summaries), 0)
        ...
        self.assertEqual(topics_and_stories_progress[1][
