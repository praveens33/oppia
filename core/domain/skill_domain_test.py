...
class SkillDomainUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        super().setUp()
        example_1 = skill_domain.WorkedExample(state_domain.SubtitledHtml(
            '2', '<p>Example Question 1</p>'), state_domain.SubtitledHtml(
            '3', '<p>Example Explanation 1</p>'))
        skill_contents = skill_domain.SkillContents(state_domain.
            SubtitledHtml('1', '<p>Explanation</p>'), [example_1],
            state_domain.RecordedVoiceovers.from_dict({'voiceovers_mapping':
            {'1': {}, '2': {}, '3': {}}}), translation_domain.
            WrittenTranslations.from_dict({'translations_mapping': {'1': {},
            '2': {}, '3': {}}}))
        misconceptions = [skill_domain.Misconception(self.MISCONCEPTION_ID,
            'name', '<p>notes</p>', '<p>default_feedback</p>', True)]
        rubrics = [skill_domain.Rubric(constants.SKILL_DIFFICULTIES[0], [
            '<p>Explanation 1</p>']), skill_domain.Rubric(constants.
            SKILL_DIFFICULTIES[1], ['<p>Explanation 2</p>']), skill_domain.
            Rubric(constants.SKILL_DIFFICULTIES[2], ['<p>Explanation 3</p>'])]
        self.skill = skill_domain.Skill(self.SKILL_ID, 'Description',
            misconceptions, rubrics, skill_contents, feconf.
            CURRENT_MISCONCEPTIONS_SCHEMA_VERSION, feconf.
            CURRENT_RUBRIC_SCHEMA_VERSION, feconf.
            CURRENT_SKILL_CONTENTS_SCHEMA_VERSION, 'en', 0, 1, None, False,
            ['skill_id_2'], created_on=datetime.datetime.now(),
    ...
    def test_valid_misconception_name(self) ->None:
        ...
        misconception_name = (
            'etiam non quam lacus suspendisse faucibus interdum posuere lorem ipsum dolor sit amet consectetur adipiscing elit duis tristique sollicitudin nibh sit amet commodo nulla facilisi'
            )
        self.skill.update_misconception_name(0, misconception_name)
        self._assert_validation_error(
    ...
    def test_update_contents_from_model(self) ->None:
        versioned_skill_contents: skill_domain.VersionedSkillContentsDict = {
            'schema_version': 1, 'skill_contents': {'explanation': {
            'content_id': '1', 'html':
            ...
            'explanation': {}}}, 'worked_examples': [{'question': {'html':
            '<p>A Question</p>', 'content_id': 'id'}, 'explanation': {
            'html': '<p>An explanation</p>', 'content_id': 'id'}}]}}
        self.skill.update_skill_contents_from_model(versioned_skill_contents,
            versioned_skill_contents['schema_version'])
        self.skill.validate()
        self.assertEqual(versioned_skill_contents['schema_version'], 2)
        self.assertEqual(versioned_skill_contents['skill_contents'][
            'explanation'], {'content_id': '1', 'html':
    ...
    def test_update_misconceptions_from_model(self) ->None:
        versioned_misconceptions: skill_domain.VersionedMisconceptionDict = {
            'schema_version': 1, 'misconceptions': [{'id': self.
            MISCONCEPTION_ID, 'name': 'name', 'notes': '<p>notes</p>',
            'feedback': '<p>feedback</p>', 'must_be_addressed': True}]}
        ...
        self.assertEqual(versioned_misconceptions['misconceptions'][0][
    ...
    def test_update_misconception_must_be_addressed(self) ->None:
        ...
        self.skill.validate()
        self.assertEqual(self.skill.misconceptions[0].must_be_addressed,
            must_be_addressed)
        with self.assertRaisesRegex(ValueError,
            'There is no misconception with the given id.'):
            self.skill.update_misconception_must_be_addressed(1,
                must_be_addressed)
    ...
    def test_add_misconception(self) ->None:
        misconception = skill_domain.Misconception(self.MISCONCEPTION_ID + 
            1, 'name_2', '<p>notes_2</p>', '<p>default_feedback_2</p>', True)
    ...
    def test_find_prerequisite_skill_id_index(self) ->None:
        self.assertEqual(self.skill._find_prerequisite_skill_id_index(
            'skill_id_2'), 0)
        self.assertEqual(self.skill._find_prerequisite_skill_id_index(
            'skill_id_3'), None)

    def test_update_explanation(self) ->None:
        new_explanation = state_domain.SubtitledHtml('1',
            '<p>New Explanation</p>')
    ...
    def test_valid_misconception_must_be_addressed(self) ->None:
        ...
        with self.assertRaisesRegex(ValueError,
            ...
            self.skill.update_misconception_must_be_addressed(0,
                must_be_addressed)
    ...
    def test_rubric_present_for_all_difficulties(self) ->None:
        self.skill.validate()
        self.skill.rubrics = [skill_domain.Rubric(constants.
            SKILL_DIFFICULTIES[0], ['<p>Explanation 1</p>']), skill_domain.
            Rubric(constants.SKILL_DIFFICULTIES[1], ['<p>Explanation 2</p>'])]
        self._assert_validation_error(
            'All 3 difficulties should be addressed in rubrics')

    def test_order_of_rubrics(self) ->None:
        self.skill.rubrics = [skill_domain.Rubric(constants.
            SKILL_DIFFICULTIES[1], ['<p>Explanation 1</p>']), skill_domain.
            Rubric(constants.SKILL_DIFFICULTIES[2], ['<p>Explanation 2</p>'
    ...
    def test_schema_versions_validation(self) ->None:
        ...
        self._assert_validation_error(
            'Expected skill contents schema version to be %s' % feconf.
        ...
        self._assert_validation_error(
            'Expected misconceptions schema version to be %s' % feconf.
        ...
        self._assert_validation_error(
            'Expected rubric schema version to be %s' % feconf.
    ...
    def test_skill_contents_validation(self) ->None:
        ...
        example = skill_domain.WorkedExample(state_domain.SubtitledHtml('2',
            '<p>Example Question 1</p>'), 'explanation')
        self.skill.skill_contents.worked_examples = [example]
        self._assert_validation_error(
    ...
    def test_validate_duplicate_content_id(self) ->None:
        self.skill.skill_contents.worked_examples = [skill_domain.
            WorkedExample(self.skill.skill_contents.explanation, self.skill
            .skill_contents.explanation)]
        self._assert_validation_error('Found a duplicate content id 1')
        example_1 = skill_domain.WorkedExample(state_domain.SubtitledHtml(
            '4', '<p>Example Question 1</p>'), state_domain.SubtitledHtml(
            '1', '<p>Example Explanation 1</p>'))
        self.skill.skill_contents.worked_examples = [example_1]
        self._assert_validation_error('Found a duplicate content id 1')

    def test_misconception_id_validation(self) ->None:
        self.skill.misconceptions = [skill_domain.Misconception(self.
            MISCONCEPTION_ID, 'name', '<p>notes</p>',
            '<p>default_feedback</p>', True), skill_domain.Misconception(
    ...
    def test_create_default_skill(self) ->None:
        ...
        rubrics = [skill_domain.Rubric(constants.SKILL_DIFFICULTIES[0], [
            '<p>[NOTE: Creator should fill this in]</p>']), skill_domain.
            Rubric(constants.SKILL_DIFFICULTIES[1], [
            '<p>[NOTE: Creator should fill this in]</p>']), skill_domain.
            Rubric(constants.SKILL_DIFFICULTIES[2], [
        ...
        expected_skill_dict = {'id': self.SKILL_ID, 'description':
            'Description', 'misconceptions': [], 'rubrics': [rubric.to_dict
            () for rubric in rubrics], 'skill_contents': {'explanation': {
            'html': feconf.DEFAULT_SKILL_EXPLANATION, 'content_id':
            'explanation'}, 'recorded_voiceovers': {'voiceovers_mapping': {
            'explanation': {}}}, 'written_translations': {
            'translations_mapping': {'explanation': {}}}, 'worked_examples':
            []}, 'misconceptions_schema_version': feconf.
            CURRENT_MISCONCEPTIONS_SCHEMA_VERSION, 'rubric_schema_version':
            feconf.CURRENT_RUBRIC_SCHEMA_VERSION,
            'skill_contents_schema_version': feconf.
            CURRENT_SKILL_CONTENTS_SCHEMA_VERSION, 'language_code':
            constants.DEFAULT_LANGUAGE_CODE, 'next_misconception_id': 0,
            'version': 0, 'superseding_skill_id': None,
            'all_questions_merged': False, 'prerequisite_skill_ids': []}
    ...
    def test_conversion_to_and_from_dict(self) ->None:
        ...
        skill_contents_from_dict = skill_domain.SkillContents.from_dict(
            skill_contents_dict)
        misconceptions = skill_domain.Misconception(self.MISCONCEPTION_ID,
            'Tag Name', '<p>Description</p>', '<p>Feedback</p>', True)
    ...
    def test_skill_mastery_to_dict(self) ->None:
        expected_skill_mastery_dict: skill_domain.UserSkillMasteryDict = {
            'user_id': 'user', 'skill_id': 'skill_id', 'degree_of_mastery': 0.5
            }
        observed_skill_mastery = skill_domain.UserSkillMastery.from_dict(
            expected_skill_mastery_dict)
        self.assertDictEqual(expected_skill_mastery_dict,
            observed_skill_mastery.to_dict())

    def test_update_worked_examples(self) ->None:
        question_1: state_domain.SubtitledHtmlDict = {'content_id':
            'question_1', 'html': '<p>Worked example question 1</p>'}
        explanation_1: state_domain.SubtitledHtmlDict = {'content_id':
            'explanation_1', 'html': '<p>Worked example explanation 1</p>'}
        question_2: state_domain.SubtitledHtmlDict = {'content_id':
            'question_2', 'html': '<p>Worked example question 2</p>'}
        explanation_2: state_domain.SubtitledHtmlDict = {'content_id':
            'explanation_2', 'html': '<p>Worked example explanation 2</p>'}
        ...
        worked_examples_object_list = [skill_domain.WorkedExample.from_dict
            (worked_example) for worked_example in worked_examples_dict_list]
    ...
    def test_serialize_and_deserialize_returns_unchanged_skill(self) ->None:
        ...
        """
        self.assertEqual(self.skill.to_dict(), skill_domain.Skill.
            deserialize(self.skill.serialize()).to_dict())

    def test_generate_skill_misconception_id(self) ->None:
        """Checks that skill misconception id is generated correctly."""
        self.assertEqual(self.skill.generate_skill_misconception_id(0), 
            '%s-%d' % (self.skill.id, 0))
        self.assertEqual(self.skill.generate_skill_misconception_id(1), 
            '%s-%d' % (self.skill.id, 1))

    def test_update_rubrics_from_model(self) ->None:
        """Checks that skill misconception id is generated correctly."""
        versioned_rubrics: skill_domain.VersionedRubricDict = {'schema_version'
            : 1, 'rubrics': [{'explanation': 'explanation1'}, {
            'explanation': 'explanation2'}]}
        skill_domain.Skill.update_rubrics_from_model(versioned_rubrics, 1)
        self.assertEqual(versioned_rubrics, {'schema_version': 2, 'rubrics':
            [{'explanations': ['explanation1']}, {'explanations': [
            'explanation2']}]})
        ...
        self.skill.validate()
        self.assertEqual(versioned_rubrics, {'schema_version': 3, 'rubrics':
            [{'explanations': [
        ...
        self.skill.validate()
        self.assertEqual(versioned_rubrics, {'schema_version': 4, 'rubrics':
            [{'explanations': [
            '<oppia-noninteractive-image alt-with-value="&amp;quot;Image&amp;quot;" caption-with-value="&amp;quot;&amp;quot;" filepath-with-value="&amp;quot;img1.svg&amp;quot;"></oppia-noninteractive-image>'
            ]}, {'explanations': ['explanation2']}]})
        versioned_rubrics['rubrics'][0]['explanations'] = [
        ...
        self.skill.validate()
        self.assertEqual(versioned_rubrics, {'schema_version': 5, 'rubrics':
...
class SkillChangeTests(test_utils.GenericTestBase):
    ...
    def test_skill_change_object_with_missing_attribute_in_cmd(self) ->None:
        with self.assertRaisesRegex(utils.ValidationError,
            ...
            skill_domain.SkillChange({'cmd': 'update_skill_property',
                'property_name': 'name'})

    def test_skill_change_object_with_extra_attribute_in_cmd(self) ->None:
        with self.assertRaisesRegex(utils.ValidationError,
            'The following extra attributes are present: invalid'):
            skill_domain.SkillChange({'cmd': 'add_skill_misconception',
                'new_misconception_dict': {'id': 0, 'name': 'name', 'notes':
                '<p>notes</p>', 'feedback': '<p>default_feedback</p>'},
                'invalid': 'invalid'})
    ...
    def test_skill_change_object_with_invalid_skill_misconception_property(self
        ) ->None:
        with self.assertRaisesRegex(utils.ValidationError,
            'Value for property_name in cmd update_skill_misconceptions_property: invalid is not allowed'
            ):
            skill_domain.SkillChange({'cmd':
                'update_skill_misconceptions_property', 'misconception_id':
                'id', 'property_name': 'invalid', 'old_value': 'old_value',
                'new_value': 'new_value'})
    ...
    def test_skill_change_object_with_invalid_skill_contents_property(self
        ...
        with self.assertRaisesRegex(utils.ValidationError,
            ...
            skill_domain.SkillChange({'cmd':
                'update_skill_contents_property', 'property_name':
                'invalid', 'old_value': 'old_value', 'new_value': 'new_value'})

    def test_skill_change_object_with_add_skill_misconception(self) ->None:
        skill_change_object = skill_domain.SkillChange({'cmd':
            'add_skill_misconception', 'new_misconception_dict': {'id': 0,
            'name': 'name', 'notes': '<p>notes</p>', 'feedback':
            '<p>default_feedback</p>'}})
        self.assertEqual(skill_change_object.cmd, 'add_skill_misconception')
        self.assertEqual(skill_change_object.new_misconception_dict, {'id':
            0, 'name': 'name', 'notes': '<p>notes</p>', 'feedback':
            '<p>default_feedback</p>'})

    def test_skill_change_object_with_update_rubrics(self) ->None:
        skill_change_object = skill_domain.SkillChange({'cmd':
            'update_rubrics', 'difficulty': constants.SKILL_DIFFICULTIES[0],
            'explanations': ['<p>Explanation</p>']})
        self.assertEqual(skill_change_object.cmd, 'update_rubrics')
        self.assertEqual(skill_change_object.difficulty, constants.
            SKILL_DIFFICULTIES[0])
        self.assertEqual(skill_change_object.explanations, [
            '<p>Explanation</p>'])

    def test_skill_change_object_with_delete_skill_misconception(self) ->None:
        skill_change_object = skill_domain.SkillChange({'cmd':
            'delete_skill_misconception', 'misconception_id': 'id'})
    ...
    def test_skill_change_object_with_update_skill_misconceptions_property(self
        ) ->None:
        skill_change_object = skill_domain.SkillChange({'cmd':
            'update_skill_misconceptions_property', 'misconception_id':
            'id', 'property_name': 'name', 'new_value': 'new_value',
            'old_value': 'old_value'})
        self.assertEqual(skill_change_object.cmd,
    ...
    def test_skill_change_object_with_update_skill_property(self) ->None:
        skill_change_object = skill_domain.SkillChange({'cmd':
            'update_skill_property', 'property_name': 'description',
    ...
    def test_skill_change_object_with_update_skill_contents_property(self
        ) ->None:
        skill_change_object = skill_domain.SkillChange({'cmd':
            'update_skill_contents_property', 'property_name':
            'explanation', 'new_value': 'new_value', 'old_value': 'old_value'})
        self.assertEqual(skill_change_object.cmd,
    ...
    def test_skill_change_object_with_migrate_contents_schema_to_latest_version(
        self) ->None:
        skill_change_object = skill_domain.SkillChange({'cmd':
            'migrate_contents_schema_to_latest_version', 'from_version':
    ...
    def test_skill_change_object_with_migrate_rubrics_schema_to_latest_version(
        self) ->None:
        skill_change_object = skill_domain.SkillChange({'cmd':
            'migrate_rubrics_schema_to_latest_version', 'from_version':
            'from_version', 'to_version': 'to_version'})
        self.assertEqual(skill_change_object.cmd,
...
class SkillSummaryTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        ...
        self.skill_summary_dict = {'id': 'skill_id', 'description':
            'description', 'language_code': 'en', 'version': 1,
            'misconception_count': 1, 'worked_examples_count': 1,
            'skill_model_created_on': time_in_millisecs,
            'skill_model_last_updated': time_in_millisecs}
        self.skill_summary = skill_domain.SkillSummary('skill_id',
            'description', 'en', 1, 1, 1, current_time, current_time)
...
class AugmentedSkillSummaryTests(test_utils.GenericTestBase):
    ...
    def test_augmented_skill_summary_gets_created(self) ->None:
        augmented_skill_summary_dict = {'id': 'skill_id', 'description':
            'description', 'language_code': 'en', 'version': 1,
            'misconception_count': 1, 'worked_examples_count': 1,
            'topic_names': ['topic1'], 'classroom_names': ['math'],
            'skill_model_created_on': self.time_in_millisecs,
            'skill_model_last_updated': self.time_in_millisecs}
        self.assertEqual(self.augmented_skill_summary.to_dict(),
...
class TopicAssignmentTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        super().setUp()
        self.topic_assignments = skill_domain.TopicAssignment('topic_id1',
            'Topic1', 2, 1)

    def test_topic_assignments_gets_created(self) ->None:
        topic_assignments_dict = {'topic_id': 'topic_id1', 'topic_name':
            'Topic1', 'topic_version': 2, 'subtopic_id': 1}
        self.assertEqual(self.topic_assignments.to_dict(),
...
class CategorizedSkillsTests(test_utils.GenericTestBase):
    ...
    def test_uncategorized_skill_gets_added(self) ->None:
        self.categorized_skills.add_uncategorized_skill('Topic Name',
            'skill_1', 'Description 1')
        self.assertEqual(self.categorized_skills.to_dict(), {'Topic Name':
            {'uncategorized': [{'skill_id': 'skill_1', 'skill_description':
            'Description 1'}], 'Subtopic Title 1': [], 'Subtopic Title 2': []}}
            )

    def test_validation_fails_with_topic_name_not_added(self) ->None:
        with self.assertRaisesRegex(utils.ValidationError,
            "Topic name 'Topic Name 1' is not added."):
            self.categorized_skills.add_uncategorized_skill('Topic Name 1',
                'skill_1', 'Description 1')

    def test_subtopic_skill_gets_added(self) ->None:
        self.categorized_skills.add_subtopic_skill('Topic Name',
            'Subtopic Title 1', 'skill_2', 'Description 2')
        self.categorized_skills.add_subtopic_skill('Topic Name',
            'Subtopic Title 2', 'skill_3', 'Description 3')
        self.assertEqual(self.categorized_skills.to_dict(), {'Topic Name':
            {'uncategorized': [], 'Subtopic Title 1': [{'skill_id':
            'skill_2', 'skill_description': 'Description 2'}],
            'Subtopic Title 2': [{'skill_id': 'skill_3',
    ...
    def test_validation_fails_with_subtopic_title_not_added(self) ->None:
        with self.assertRaisesRegex(utils.ValidationError,
            ...
            self.categorized_skills.add_subtopic_skill('Topic Name',
                'Subtopic Title 3', 'skill_1', 'Description 1')
...
class ShortSkillSummaryTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        super().setUp()
        self.skill_summary = skill_domain.SkillSummary('skill_1',
            'Description 1', 'en', 1, 0, 0, datetime.datetime.now(),
            datetime.datetime.now())
        self.short_skill_summary = skill_domain.ShortSkillSummary('skill_1',
            'Description 1')

    def test_short_skill_summary_gets_created(self) ->None:
        short_skill_summary_dict = {'skill_id': 'skill_1',
            'skill_description': 'Description 1'}
        self.assertEqual(self.short_skill_summary.to_dict(),
            short_skill_summary_dict)

    def test_short_skill_summary_gets_created_from_skill_summary(self) ->None:
        short_skill_summary = (skill_domain.ShortSkillSummary.
            from_skill_summary(self.skill_summary))
        self.assertEqual(short_skill_summary.to_dict(), self.
