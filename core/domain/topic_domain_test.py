...
class TopicDomainUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        ...
        self.topic = topic_domain.Topic.create_default_topic(self.topic_id,
            'Name', 'abbrev', 'description', 'fragm')
        self.topic.subtopics = [topic_domain.Subtopic(1, 'Title', [
    ...
    def test_create_default_topic(self) ->None:
        ...
        expected_topic_dict: topic_domain.TopicDict = {'id': self.topic_id,
            'name': 'Name', 'abbreviated_name': 'Name', 'url_fragment':
            'abbrev', 'thumbnail_filename': None, 'thumbnail_bg_color':
            None, 'thumbnail_size_in_bytes': None, 'description':
            ...
            constants.DEFAULT_LANGUAGE_CODE, 'subtopic_schema_version':
            feconf.CURRENT_SUBTOPIC_SCHEMA_VERSION,
            'story_reference_schema_version': feconf.
            CURRENT_STORY_REFERENCE_SCHEMA_VERSION, 'version': 0,
            'practice_tab_is_displayed': False, 'meta_tag_content': '',
    ...
    def test_delete_canonical_story(self) ->None:
        self.topic.canonical_story_references = [topic_domain.
            StoryReference.create_default_story_reference('story_id'),
            topic_domain.StoryReference.create_default_story_reference(
            'story_id_1'), topic_domain.StoryReference.
            create_default_story_reference('story_id_2')]
        ...
        with self.assertRaisesRegex(Exception,
            'The story_id story_id_5 is not present in the canonical story references list of the topic.'
            ):
    ...
    def test_rearrange_canonical_story_fail_with_out_of_bound_indexes(self
        ...
        self.topic.canonical_story_references = [topic_domain.
            StoryReference.create_default_story_reference('story_id_1')]
        with self.assertRaisesRegex(Exception,
    ...
    def test_rearrange_canonical_story(self) ->None:
        self.topic.canonical_story_references = [topic_domain.
            StoryReference.create_default_story_reference('story_id_1'),
            topic_domain.StoryReference.create_default_story_reference(
            'story_id_2'), topic_domain.StoryReference.
            create_default_story_reference('story_id_3')]
        canonical_story_ids = self.topic.get_canonical_story_ids()
    ...
    def test_rearrange_skill_in_subtopic(self) ->None:
        self.topic.subtopics = [topic_domain.Subtopic(1, 'Title', [
            'skill_id_1', 'skill_id_2', 'skill_id_3'], 'image.svg',
    ...
    def test_rearrange_subtopic(self) ->None:
        self.topic.subtopics = [topic_domain.Subtopic(1, 'Title1', [], None,
            None, None, 'title-one'), topic_domain.Subtopic(2, 'Title2', [],
            None, None, None, 'title-two'), topic_domain.Subtopic(3,
            'Title3', [], None, None, None, 'title-three')]
    ...
    def test_get_all_story_references(self) ->None:
        self.topic.canonical_story_references = [topic_domain.
            ...
            topic_domain.StoryReference.create_default_story_reference(
            'story_id_1')]
        self.topic.additional_story_references = [topic_domain.
            StoryReference.create_default_story_reference('story_id_2'),
            topic_domain.StoryReference.create_default_story_reference(
            'story_id_3')]
    ...
    def test_add_canonical_story(self) ->None:
        ...
        canonical_story_ids = self.topic.get_canonical_story_ids()
        self.assertEqual(canonical_story_ids, ['story_id', 'story_id_1',
            'story_id_2'])
        with self.assertRaisesRegex(Exception,
            'The story_id story_id_2 is already present in the canonical story references list of the topic.'
            ):
            self.topic.add_canonical_story('story_id_2')
    ...
    def test_delete_additional_story(self) ->None:
        ...
        with self.assertRaisesRegex(Exception,
            'The story_id story_id_5 is not present in the additional story references list of the topic.'
            ):
    ...
    def test_add_additional_story(self) ->None:
        ...
        additional_story_ids = self.topic.get_additional_story_ids()
        self.assertEqual(additional_story_ids, ['story_id', 'story_id_1',
            'story_id_2'])
        with self.assertRaisesRegex(Exception,
            'The story_id story_id_2 is already present in the additional story references list of the topic.'
            ):
            self.topic.add_additional_story('story_id_2')
    ...
    def _assert_strict_validation_error(self, expected_error_substring: str
        ) ->None:
    ...
    def _assert_valid_topic_id(self, expected_error_substring: str,
        topic_id: str) ->None:
    ...
    def _assert_valid_name_for_topic(self, expected_error_substring: str,
        name: str) ->None:
        """Checks that the topic passes strict validation."""
        with self.assertRaisesRegex(utils.ValidationError,
            expected_error_substring):
    ...
    def _assert_valid_thumbnail_filename_for_topic(self,
    ...
    def _assert_valid_thumbnail_filename_for_subtopic(self,
        expected_error_substring: str, thumbnail_filename: str) ->None:
    ...
    def test_valid_name_topic(self) ->None:
        ...
        self._assert_valid_name_for_topic(
            'Topic name should be at most 39 characters, received aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'
    ...
    def test_subtopic_url_fragment_validation(self) ->None:
        ...
        self._assert_validation_error(
            'Expected subtopic url fragment to be less than or equal to %d characters'
        ...
        self._assert_validation_error('Invalid url fragment: %s' % self.
            topic.subtopics[0].url_fragment)
    ...
    def test_validation_fails_with_lengthy_url_fragment(self) ->None:
        ...
        validation_message = (
            'Topic URL Fragment field should not exceed %d characters, received %s.'
    ...
    def test_subtopic_schema_version_validation(self) ->None:
        ...
        self._assert_validation_error(
            'Expected subtopic schema version to be %s' % feconf.
            CURRENT_SUBTOPIC_SCHEMA_VERSION)
    ...
    def test_next_subtopic_id_validation(self) ->None:
        ...
        self._assert_validation_error(
            'The id for subtopic 1 is greater than or equal to next_subtopic_id 1'
            )
    ...
    def test_additional_canonical_story_intersection_validation(self) ->None:
        ...
        self.topic.canonical_story_references = [topic_domain.
            ...
            'story_id_2')]
        self._assert_validation_error(
            'Expected additional story ids list and canonical story ids list to be mutually exclusive.'
            )

    def test_add_uncategorized_skill_id(self) ->None:
        self.topic.subtopics.append(topic_domain.Subtopic(1, 'Title2', [
            'skill_id_2'], 'image.svg', constants.
            ALLOWED_THUMBNAIL_BG_COLORS['subtopic'][0], 21131,
            'dummy-title-two'))
        with self.assertRaisesRegex(Exception,
    ...
    def test_move_skill_id_to_subtopic(self) ->None:
        ...
        self.assertEqual(self.topic.uncategorized_skill_ids, [])
        self.assertEqual(self.topic.subtopics[0].skill_ids, ['skill_id_2',
            'skill_id_1'])
        self.topic.uncategorized_skill_ids = ['skill_id_1']
        self.topic.subtopics[0].skill_ids = ['skill_id_2']
        with self.assertRaisesRegex(Exception,
    ...
    def test_update_subtopic_url_fragment(self) ->None:
        self.assertEqual(len(self.topic.subtopics), 1)
        self.assertEqual(self.topic.subtopics[0].url_fragment,
            'dummy-subtopic-url')
    ...
    def test_cannot_move_existing_skill_to_subtopic(self) ->None:
        self.topic.subtopics = [topic_domain.Subtopic(1, 'Title', [
            'skill_id_1'], 'image.svg', constants.
            ALLOWED_THUMBNAIL_BG_COLORS['subtopic'][0], 21131,
            'dummy-subtopic-one'), topic_domain.Subtopic(2, 'Another title',
            ['skill_id_1'], 'image.svg', constants.
            ALLOWED_THUMBNAIL_BG_COLORS['subtopic'][0], 21131,
            'dummy-subtopic-two')]
        with self.assertRaisesRegex(Exception,
    ...
    def test_story_ref_to_dict(self) ->None:
        test_story_dict = {'story_id': 'story_id_1', 'story_is_published': 
            False}
    ...
    def test_story_ref_from_dict(self) ->None:
        test_story_dict = topic_domain.StoryReference('story_id_1', False
            ).to_dict()
    ...
    def test_create_default_subtopic(self) ->None:
        ...
        subtopic_obj = topic_domain.Subtopic.create_default_subtopic(
            subtopic_id, subtopic_title, url_frag)
    ...
    def test_update_subtopic_thumbnail(self) ->None:
        ...
        self.assertNotEqual(new_filename, self.topic.subtopics[
            subtopic_index].thumbnail_filename)
        self.assertNotEqual(new_filesize, self.topic.subtopics[
            subtopic_index].thumbnail_size_in_bytes)
        self.topic.update_subtopic_thumbnail_filename_and_size(1,
            new_filename, new_filesize)
        self.assertEqual(new_filename, self.topic.subtopics[subtopic_index]
            .thumbnail_filename)
        self.assertEqual(new_filesize, self.topic.subtopics[subtopic_index]
    ...
    def test_delete_subtopic(self) ->None:
        ...
        self.assertNotEqual([skill_id_moved], self.topic.
    ...
    def test_move_skill_id_from_subtopic_to_subtopic(self) ->None:
        ...
        self.topic.subtopics = [topic_domain.Subtopic(1, 'Title', [
            ...
            ALLOWED_THUMBNAIL_BG_COLORS['subtopic'][0], 21131,
            'dummy-subtopic-two')]
        self.assertNotEqual(self.topic.subtopics[0].skill_ids,
            expected_subtopic1_skills)
        self.assertNotEqual(self.topic.subtopics[1].skill_ids,
            expected_subtopic2_skills)
        self.topic.move_skill_id_to_subtopic(1, 2, 'skill_id_1')
        self.assertEqual(self.topic.subtopics[0].skill_ids,
            expected_subtopic1_skills)
        self.assertEqual(self.topic.subtopics[1].skill_ids,
            expected_subtopic2_skills)
    ...
    def test_move_skill_id_from_uncategorized_to_subtopic(self) ->None:
        ...
        self.assertNotEqual(self.topic.uncategorized_skill_ids,
    ...
    def test_add_subtopic(self) ->None:
        ...
        with self.assertRaisesRegex(Exception, 
            'The given new subtopic id %s is not equal to the expected next subtopic id: %s'
             % (incorrect_new_subtopic_id, expected_subtopic_id)):
            self.topic.add_subtopic(incorrect_new_subtopic_id, 'subtopic_3',
                'url_frag')
        self.topic.add_subtopic(correct_new_subtopic_id, 'subtopic_title',
            'url_frag')
    ...
    def test_update_page_title_fragment_for_web(self) ->None:
        ...
        self.assertNotEqual(self.topic.page_title_fragment_for_web,
            updated_frag)
    ...
    def test_update_thumbnail_file_and_size(self) ->None:
        ...
        self.topic.update_thumbnail_filename_and_size(updated_file_name,
            updated_size)
    ...
    @classmethod
    def _schema_update_vers_dict(cls, current_schema: int, topic:
        topic_domain.Topic) ->topic_domain.VersionedSubtopicsDict:
        ...
        vers_subtopic_dict = topic_domain.VersionedSubtopicsDict({
            'schema_version': current_schema, 'subtopics': [subtopic_dict]})
        topic.update_subtopics_from_model(vers_subtopic_dict,
            current_schema, topic.id)
    ...
    def test_subtopic_schema_v1_to_v2(self) ->None:
        ...
        vers_subtopic_dict = TopicDomainUnitTests._schema_update_vers_dict(
            current_schema, self.topic)
        self.assertEqual(vers_subtopic_dict['subtopics'][0][
            'thumbnail_filename'], None)
        self.assertEqual(vers_subtopic_dict['subtopics'][0][
            'thumbnail_bg_color'], None)
        self.assertEqual(vers_subtopic_dict['schema_version'], 
            current_schema + 1)
    ...
    def test_subtopic_schema_v2_to_v3(self) ->None:
        ...
        vers_subtopic_dict = TopicDomainUnitTests._schema_update_vers_dict(
            current_schema, self.topic)
        self.assertEqual(vers_subtopic_dict['subtopics'][0]['url_fragment'],
            expected_frag)
        self.assertEqual(vers_subtopic_dict['schema_version'], 
            current_schema + 1)
    ...
    class MockTopicObject(topic_domain.Topic):
        ...
        @classmethod
        def _convert_story_reference_v1_dict_to_v2_dict(cls,
            story_reference: topic_domain.StoryReferenceDict
    ...
    def test_story_schema_update(self) ->None:
        ...
        schema_version = 1
        story_ref_dict = topic_domain.StoryReference(story_id, story_published
            ).to_dict()
        vers_story_ref_dict = topic_domain.VersionedStoryReferencesDict({
            'schema_version': 1, 'story_references': [story_ref_dict]})
        swap_topic_object = self.swap(topic_domain, 'Topic', self.
            MockTopicObject)
        current_schema_version_swap = self.swap(feconf,
    ...
    def _setup_stories(self, topic: topic_domain.Topic) ->None:
        ...
        topic.canonical_story_references = [topic_domain.StoryReference.
            create_default_story_reference('story_id'), topic_domain.
            StoryReference.create_default_story_reference('story_id_1'),
            topic_domain.StoryReference.create_default_story_reference(
            'story_id_2')]
        topic.additional_story_references = [topic_domain.StoryReference.
            create_default_story_reference('story_id_10'), topic_domain.
            StoryReference.create_default_story_reference('story_id_11'),
            topic_domain.StoryReference.create_default_story_reference(
            'story_id_12')]
    ...
    def test_publish_story(self) ->None:
        ...
        self.assertEqual(topic.canonical_story_references[0].
            story_is_published, True)
        topic.publish_story('story_id_10')
        self.assertEqual(topic.additional_story_references[0].
            story_is_published, True)
    ...
    def test_unpublish_story(self) ->None:
        ...
        self.assertEqual(topic.canonical_story_references[1].
            story_is_published, False)
    ...
    def test_validate_same_subtopic_url(self) ->None:
        self.topic.subtopics = [topic_domain.Subtopic(1, 'Title', [
            'skill_id_1'], 'image.svg', constants.
            ALLOWED_THUMBNAIL_BG_COLORS['subtopic'][0], 21131,
            'dummy-subtopic-one'), topic_domain.Subtopic(1, 'Another title',
            ['skill_id_2'], 'image.svg', constants.
            ALLOWED_THUMBNAIL_BG_COLORS['subtopic'][0], 21131,
            'dummy-subtopic-two')]
    ...
    def test_serialize_and_deserialize_returns_unchanged_topic(self) ->None:
        ...
        """
        self.assertEqual(self.topic.to_dict(), topic_domain.Topic.
            deserialize(self.topic.serialize()).to_dict())
    ...
    def test_serialize_with_created_on_last_updated_set(self) ->None:
        ...
        """
        self.topic.created_on = get_current_datetime_utc()
        self.topic.last_updated = get_current_datetime_utc()
        self.assertEqual(self.topic.to_dict(), topic_domain.Topic.
            deserialize(self.topic.serialize()).to_dict())
    ...
    def test_skill_ids_for_diagnostic_test_validation(self) ->None:
        ...
        error_msg = (
            "The skill_ids {'test_skill_id'} are selected for the diagnostic test but they are not associated with the topic."
            )
...
class TopicChangeTests(test_utils.GenericTestBase):
    ...
    def test_topic_change_object_with_missing_attribute_in_cmd(self) ->None:
        with self.assertRaisesRegex(utils.ValidationError,
            ...
            topic_domain.TopicChange({'cmd': 'update_topic_property',
                'property_name': 'name'})

    def test_topic_change_object_with_extra_attribute_in_cmd(self) ->None:
        with self.assertRaisesRegex(utils.ValidationError,
            'The following extra attributes are present: invalid'):
            topic_domain.TopicChange({'cmd': 'add_subtopic', 'title':
                'title', 'subtopic_id': 'subtopic_id', 'url_fragment':
                'url-fragment', 'invalid': 'invalid'})
    ...
    def test_topic_change_object_with_invalid_subtopic_property(self) ->None:
        with self.assertRaisesRegex(utils.ValidationError,
            ...
            topic_domain.TopicChange({'cmd': 'update_subtopic_property',
                'subtopic_id': 'subtopic_id', 'property_name': 'invalid',
    ...
    def test_topic_change_object_with_invalid_subtopic_page_property(self
        ...
        with self.assertRaisesRegex(utils.ValidationError,
            ...
            topic_domain.TopicChange({'cmd':
                'update_subtopic_page_property', 'subtopic_id':
                'subtopic_id', 'property_name': 'invalid', 'old_value':
                'old_value', 'new_value': 'new_value'})

    def test_topic_change_object_with_add_subtopic(self) ->None:
        topic_change_object = topic_domain.TopicChange({'cmd':
            'add_subtopic', 'subtopic_id': 'subtopic_id', 'title': 'title',
    ...
    def test_topic_change_object_with_delete_subtopic(self) ->None:
        topic_change_object = topic_domain.TopicChange({'cmd':
            'delete_subtopic', 'subtopic_id': 'subtopic_id'})
    ...
    def test_topic_change_object_with_add_uncategorized_skill_id(self) ->None:
        topic_change_object = topic_domain.TopicChange({'cmd':
            'add_uncategorized_skill_id', 'new_uncategorized_skill_id':
            'new_uncategorized_skill_id'})
        self.assertEqual(topic_change_object.cmd, 'add_uncategorized_skill_id')
        self.assertEqual(topic_change_object.new_uncategorized_skill_id,
            'new_uncategorized_skill_id')

    def test_topic_change_object_with_remove_uncategorized_skill_id(self
        ) ->None:
        topic_change_object = topic_domain.TopicChange({'cmd':
            'remove_uncategorized_skill_id', 'uncategorized_skill_id':
            'uncategorized_skill_id'})
        self.assertEqual(topic_change_object.cmd,
            'remove_uncategorized_skill_id')
        self.assertEqual(topic_change_object.uncategorized_skill_id,
            'uncategorized_skill_id')

    def test_topic_change_object_with_move_skill_id_to_subtopic(self) ->None:
        topic_change_object = topic_domain.TopicChange({'cmd':
            'move_skill_id_to_subtopic', 'skill_id': 'skill_id',
            'old_subtopic_id': 'old_subtopic_id', 'new_subtopic_id':
            'new_subtopic_id'})
    ...
    def test_topic_change_object_with_remove_skill_id_from_subtopic(self
        ...
        topic_change_object = topic_domain.TopicChange({'cmd':
            'remove_skill_id_from_subtopic', 'skill_id': 'skill_id',
            'subtopic_id': 'subtopic_id'})
        self.assertEqual(topic_change_object.cmd,
            'remove_skill_id_from_subtopic')
        self.assertEqual(topic_change_object.skill_id, 'skill_id')
        self.assertEqual(topic_change_object.subtopic_id, 'subtopic_id')

    def test_topic_change_object_with_update_subtopic_property(self) ->None:
        topic_change_object = topic_domain.TopicChange({'cmd':
            'update_subtopic_property', 'subtopic_id': 'subtopic_id',
    ...
    def test_topic_change_object_with_update_subtopic_page_property(self
        ...
        topic_change_object = topic_domain.TopicChange({'cmd':
            'update_subtopic_page_property', 'subtopic_id': 'subtopic_id',
            'property_name': 'page_contents_html', 'new_value': 'new_value',
            'old_value': 'old_value'})
        self.assertEqual(topic_change_object.cmd,
            'update_subtopic_page_property')
        self.assertEqual(topic_change_object.subtopic_id, 'subtopic_id')
        self.assertEqual(topic_change_object.property_name,
            'page_contents_html')
        self.assertEqual(topic_change_object.new_value, 'new_value')
        self.assertEqual(topic_change_object.old_value, 'old_value')
    ...
    def test_topic_change_object_with_update_topic_property(self) ->None:
        topic_change_object = topic_domain.TopicChange({'cmd':
            'update_topic_property', 'property_name': 'name', 'new_value':
    ...
    def test_topic_change_object_with_create_new(self) ->None:
        topic_change_object = topic_domain.TopicChange({'cmd': 'create_new',
            'name': 'name'})
    ...
    def test_topic_change_object_with_migrate_subtopic_schema_to_latest_version(
        self) ->None:
        topic_change_object = topic_domain.TopicChange({'cmd':
            'migrate_subtopic_schema_to_latest_version', 'from_version':
...
class TopicRightsChangeTests(test_utils.GenericTestBase):
    ...
    def test_topic_rights_change_object_with_missing_attribute_in_cmd(self
        ...
        with self.assertRaisesRegex(utils.ValidationError,
            ...
            topic_domain.TopicRightsChange({'cmd': 'change_role',
    ...
    def test_topic_rights_change_object_with_extra_attribute_in_cmd(self
        ...
        with self.assertRaisesRegex(utils.ValidationError,
            'The following extra attributes are present: invalid'):
            topic_domain.TopicRightsChange({'cmd': 'publish_topic',
                'invalid': 'invalid'})
    ...
    def test_topic_rights_change_object_with_change_role(self) ->None:
        ...
        self.assertEqual(topic_rights_change_object.old_role, topic_domain.
            ROLE_NONE)
        self.assertEqual(topic_rights_change_object.new_role, topic_domain.
            ROLE_MANAGER)
    ...
    def test_to_dict(self) ->None:
        topic_rights_change_dict = {'cmd': 'change_role', 'assignee_id':
            'assignee_id', 'old_role': topic_domain.ROLE_NONE, 'new_role':
...
class TopicSummaryTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        ...
        self.topic_summary_dict = {'url_fragment': 'url-frag', 'id':
            'topic_id', 'name': 'name', 'description': 'topic description',
            'language_code': 'en', 'version': 1, 'canonical_story_count': 1,
            'additional_story_count': 1, 'uncategorized_skill_count': 1,
            'subtopic_count': 1, 'total_skill_count': 1,
            'total_published_node_count': 1, 'thumbnail_filename':
            'image.svg', 'thumbnail_bg_color': '#C6DCDA',
        ...
        self.topic_summary = topic_domain.TopicSummary('topic_id', 'name',
            'name', 'en', 'topic description', 1, 1, 1, 1, 1, 1, 1,
            'image.svg', '#C6DCDA', 'url-frag', {'story': ['exp']},
    ...
    def test_validation_fails_with_negative_additional_story_count(self
        ...
        self._assert_validation_error(
            "Expected additional_story_count to be non-negative, received '-1'"
            )
    ...
    def test_validation_fails_with_negative_uncategorized_skill_count(self
        ...
        self._assert_validation_error(
            "Expected uncategorized_skill_count to be non-negative, received '-1'"
            )
    ...
    def test_validation_fails_with_invalid_total_skill_count_value(self
        ...
        self._assert_validation_error(
            "Expected total_skill_count to be greater than or equal to uncategorized_skill_count 10, received '5'"
            )
    ...
    def test_validation_fails_with_negative_total_published_node_count(self
        ...
        self._assert_validation_error(
            "Expected total_published_node_count to be non-negative, received '-1'"
            )
...
class TopicRightsTests(test_utils.GenericTestBase):
    ...
    def setUp(self) ->None:
        ...
        self.user_id_a = self.get_user_id_from_email('a@example.com')
        self.user_id_b = self.get_user_id_from_email('b@example.com')
        self.topic_summary = topic_domain.TopicRights('topic_id', [self.
            user_id_a], False)
...
class TopicChapterCountsTests(test_utils.GenericTestBase):
    ...
    def test_topic_chapter_counts_object_is_created(self) ->None:
        topic_chapter_counts = topic_domain.TopicChapterCounts(2, 3, [4, 5],
            [2, 2])
        ...
        self.assertEqual(topic_chapter_counts.
            total_chapter_counts_for_each_story, [4, 5])
        self.assertEqual(topic_chapter_counts.
            published_chapter_counts_for_each_story, [2, 2])
